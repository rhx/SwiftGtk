...
public protocol MenuAccessibleProtocol: MenuShellAccessibleProtocol {
    ...
    /// Required Initialiser for types conforming to `MenuAccessibleProtocol`
...
// MARK: MenuAccessible has no signals
// MARK: MenuAccessible Class: MenuAccessibleProtocol extension (methods and fields)
public extension MenuAccessibleProtocol {
...
public protocol MenuBarProtocol: MenuShellProtocol {
    ...
    /// Required Initialiser for types conforming to `MenuBarProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
// MARK: MenuBar has no signals
// MARK: MenuBar Class: MenuBarProtocol extension (methods and fields)
public extension MenuBarProtocol {
...
public protocol MenuButtonAccessibleProtocol: ToggleButtonAccessibleProtocol {
    ...
    /// Required Initialiser for types conforming to `MenuButtonAccessibleProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
// MARK: MenuButtonAccessible has no signals
// MARK: MenuButtonAccessible Class: MenuButtonAccessibleProtocol extension (methods and fields)
public extension MenuButtonAccessibleProtocol {
...
public extension MenuItemProtocol {
    ...
    @inlinable @discardableResult func connect(signal s: MenuItemSignalName, flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping SignalHandler) -> Int {
    ...
    /// - Returns: The signal handler ID (always greater than 0 for successful connections)
    @inlinable @discardableResult func connect(signal s: MenuItemSignalName, flags f: ConnectFlags = ConnectFlags(0), data userData: gpointer!, destroyData destructor: GClosureNotify? = nil, signalHandler h: @escaping GCallback) -> Int {
        connectSignal(s, flags: f, data: userData, destroyData: destructor, handler: h)
    }
    
    
    /// - Note: This represents the underlying `toggle-size-request` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter object: none
    /// - Parameter handler: The signal handler to call
    /// - Warning: a `onToggleSizeRequest` wrapper for this signal could not be generated because it contains unimplemented features: { (4)  gpointer argument is not yet supported }
    /// - Note: Instead, you can connect `toggleSizeRequestSignal` using the `connect(signal:)` methods
    static var toggleSizeRequestSignal: MenuItemSignalName { .toggleSizeRequest }
    /// Emitted when the item is activated.
    ...
    static var activateSignal: MenuItemSignalName { .activate }
    
    /// Emitted when the item is activated, but also if the menu item has a
    /// submenu. For normal applications, the relevant signal is
    /// `GtkMenuItem::activate`.
    /// - Note: This represents the underlying `activate-item` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `activateItem` signal is emitted
    ...
    static var activateItemSignal: MenuItemSignalName { .activateItem }
    
    /// - Note: This represents the underlying `deselect` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `deselect` signal is emitted
    ...
    static var deselectSignal: MenuItemSignalName { .deselect }
    
    /// - Note: This represents the underlying `select` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `select` signal is emitted
    ...
    static var selectSignal: MenuItemSignalName { .select }
    
    /// - Note: This represents the underlying `toggle-size-allocate` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter object: none
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `toggleSizeAllocate` signal is emitted
    ...
    static var toggleSizeAllocateSignal: MenuItemSignalName { .toggleSizeAllocate }
    ...
    static var notifyAccelPathSignal: MenuItemSignalName { .notifyAccelPath }
    ...
    static var notifyLabelSignal: MenuItemSignalName { .notifyLabel }
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: This represents the underlying `notify::right-justified` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifyRightJustified` signal is emitted
    ...
    static var notifyRightJustifiedSignal: MenuItemSignalName { .notifyRightJustified }
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: This represents the underlying `notify::submenu` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifySubmenu` signal is emitted
    ...
    static var notifySubmenuSignal: MenuItemSignalName { .notifySubmenu }
    ...
    static var notifyUseUnderlineSignal: MenuItemSignalName { .notifyUseUnderline }
...
public protocol MenuItemAccessibleProtocol: ContainerAccessibleProtocol, Atk.ActionProtocol, Atk.SelectionProtocol {
    ...
    /// Required Initialiser for types conforming to `MenuItemAccessibleProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
// MARK: MenuItemAccessible has no signals
// MARK: MenuItemAccessible Class: MenuItemAccessibleProtocol extension (methods and fields)
public extension MenuItemAccessibleProtocol {
...
public extension MenuShellProtocol {
    ...
    ///   - handler: The Swift signal handler (function or callback) to invoke on the given signal
    /// - Returns: The signal handler ID (always greater than 0 for successful connections)
    @inlinable @discardableResult func connect(signal s: MenuShellSignalName, flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping SignalHandler) -> Int {
        connect(s, flags: f, handler: h)
    }
    ...
    ///   - signalHandler: The C function to be called on the given signal
    /// - Returns: The signal handler ID (always greater than 0 for successful connections)
    @inlinable @discardableResult func connect(signal s: MenuShellSignalName, flags f: ConnectFlags = ConnectFlags(0), data userData: gpointer!, destroyData destructor: GClosureNotify? = nil, signalHandler h: @escaping GCallback) -> Int {
        connectSignal(s, flags: f, data: userData, destroyData: destructor, handler: h)
    }
    ...
    /// An action signal that activates the current menu item within
    /// the menu shell.
    /// - Note: This represents the underlying `activate-current` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter forceHide: if `true`, hide the menu after activating the menu item
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `activateCurrent` signal is emitted
    @discardableResult @inlinable func onActivateCurrent(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ forceHide: Bool) -> Void ) -> Int {
    ...
    static var activateCurrentSignal: MenuShellSignalName { .activateCurrent }
    ...
    @discardableResult @inlinable func onCancel(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef) -> Void ) -> Int {
    ...
    static var cancelSignal: MenuShellSignalName { .cancel }
    
    /// A keybinding signal which moves the focus in the
    /// given `direction`.
    /// - Note: This represents the underlying `cycle-focus` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter direction: the direction to cycle in
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `cycleFocus` signal is emitted
    @discardableResult @inlinable func onCycleFocus(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ direction: DirectionType) -> Void ) -> Int {
    ...
    static var cycleFocusSignal: MenuShellSignalName { .cycleFocus }
    ...
    @discardableResult @inlinable func onDeactivate(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<MenuShellRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer) -> Void = { unownedSelf, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(MenuShellRef(raw: unownedSelf))
    ...
    static var deactivateSignal: MenuShellSignalName { .deactivate }
    ...
    /// 
    /// The inverse of this signal is the GtkContainer`removed` signal.
    /// - Note: This represents the underlying `insert` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter child: the `GtkMenuItem` that is being inserted
    /// - Parameter position: the position at which the insert occurs
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `insert` signal is emitted
    @discardableResult @inlinable func onInsert(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ child: WidgetRef, _ position: Int) -> Void ) -> Int {
    ...
    static var insertSignal: MenuShellSignalName { .insert }
    
    /// An keybinding signal which moves the current menu item
    /// in the direction specified by `direction`.
    /// - Note: This represents the underlying `move-current` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter direction: the direction to move
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `moveCurrent` signal is emitted
    @discardableResult @inlinable func onMoveCurrent(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ direction: MenuDirectionType) -> Void ) -> Int {
    ...
    static var moveCurrentSignal: MenuShellSignalName { .moveCurrent }
    
    /// The `move-selected` signal is emitted to move the selection to
    /// another item.
    /// - Note: This represents the underlying `move-selected` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    ...
    /// Run the given callback whenever the `moveSelected` signal is emitted
    @discardableResult @inlinable func onMoveSelected(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ distance: Int) -> Bool ) -> Int {
    ...
    static var moveSelectedSignal: MenuShellSignalName { .moveSelected }
    
    /// This signal is emitted when a selection has been
    /// completed within a menu shell.
    /// - Note: This represents the underlying `selection-done` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `selectionDone` signal is emitted
    @discardableResult @inlinable func onSelectionDone(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<MenuShellRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer) -> Void = { unownedSelf, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(MenuShellRef(raw: unownedSelf))
    ...
    static var selectionDoneSignal: MenuShellSignalName { .selectionDone }
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: This represents the underlying `notify::take-focus` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifyTakeFocus` signal is emitted
    @discardableResult @inlinable func onNotifyTakeFocus(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuShellRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
    ...
    static var notifyTakeFocusSignal: MenuShellSignalName { .notifyTakeFocus }
...
public protocol MenuShellAccessibleProtocol: ContainerAccessibleProtocol, Atk.SelectionProtocol {
    ...
    /// Required Initialiser for types conforming to `MenuShellAccessibleProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
// MARK: MenuShellAccessible has no signals
// MARK: MenuShellAccessible Class: MenuShellAccessibleProtocol extension (methods and fields)
public extension MenuShellAccessibleProtocol {
...
public extension MenuToolButtonProtocol {
    ...
    ///   - handler: The Swift signal handler (function or callback) to invoke on the given signal
    /// - Returns: The signal handler ID (always greater than 0 for successful connections)
    @inlinable @discardableResult func connect(signal s: MenuToolButtonSignalName, flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping SignalHandler) -> Int {
        connect(s, flags: f, handler: h)
    }
    ...
    ///   - signalHandler: The C function to be called on the given signal
    /// - Returns: The signal handler ID (always greater than 0 for successful connections)
    @inlinable @discardableResult func connect(signal s: MenuToolButtonSignalName, flags f: ConnectFlags = ConnectFlags(0), data userData: gpointer!, destroyData destructor: GClosureNotify? = nil, signalHandler h: @escaping GCallback) -> Int {
        connectSignal(s, flags: f, data: userData, destroyData: destructor, handler: h)
    }
    ...
    /// you must set an empty menu on the `GtkMenuToolButton` beforehand,
    /// since the arrow is made insensitive if the menu is not set.
    /// - Note: This represents the underlying `show-menu` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `showMenu` signal is emitted
    @discardableResult @inlinable func onShowMenu(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuToolButtonRef) -> Void ) -> Int {
    ...
    static var showMenuSignal: MenuToolButtonSignalName { .showMenu }
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: This represents the underlying `notify::menu` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifyMenu` signal is emitted
    @discardableResult @inlinable func onNotifyMenu(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuToolButtonRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
    ...
    static var notifyMenuSignal: MenuToolButtonSignalName { .notifyMenu }
...
// MARK: ModelButton has no signals
// MARK: ModelButton Class: ModelButtonProtocol extension (methods and fields)
public extension ModelButtonProtocol {

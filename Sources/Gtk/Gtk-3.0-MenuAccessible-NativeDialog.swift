...
public struct MenuAccessibleRef: MenuAccessibleProtocol {
    /// Untyped pointer to the underlying `GtkMenuAccessible` instance.
...
public extension MenuAccessibleRef {
    ...
    init(_ p: UnsafeMutablePointer<GtkMenuAccessible>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuAccessibleProtocol`
    init<T: MenuAccessibleProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuAccessible: MenuShellAccessible, MenuAccessibleProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuAccessible` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuAccessible>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuAccessibleProtocol`
    /// Will retain `GtkMenuAccessible`.
    public convenience init<T: MenuAccessibleProtocol>(_ other: T) {
        self.init(cast(other.menu_accessible_ptr))
        g_object_ref(cast(menu_accessible_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuAccessibleProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuAccessible.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuAccessibleProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuAccessibleProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuAccessibleProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuAccessible>(opaquePointer))
    }
...
public extension MenuAccessibleProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuAccessiblePropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let rv = GLibObject.ObjectRef(cast(menu_accessible_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
...
public enum MenuAccessibleSignalName: String, SignalNameProtocol {
...
public extension MenuAccessibleProtocol {
    /// Connect a `MenuAccessibleSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuAccessibleSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_accessible_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuAccessibleProtocol {
    ...
    var menu_accessible_ptr: UnsafeMutablePointer<GtkMenuAccessible> { return ptr.assumingMemoryBound(to: GtkMenuAccessible.self) }
...
/// 
/// GtkMenuBar has a single CSS node with name menubar.
public struct MenuBarRef: MenuBarProtocol {
    /// Untyped pointer to the underlying `GtkMenuBar` instance.
...
public extension MenuBarRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuBar>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuBarProtocol`
    init<T: MenuBarProtocol>(_ other: T) {
        ptr = other.ptr
    }
    ...
    init(model: MenuModelProtocol) {
        let rv = gtk_menu_bar_new_from_model(cast(model.ptr))
        self.init(cast(rv))
    }
    /// Creates a new `GtkMenuBar` and populates it with menu items
    /// and submenus according to `model`.
    ...
    /// by means of being contained within the `GtkApplicationWindows`
    /// widget hierarchy.
    static func newFrom(model: MenuModelProtocol) -> MenuBarRef! {
        let rv = gtk_menu_bar_new_from_model(cast(model.ptr))
        return rv.map { MenuBarRef(cast($0)) }
    }
}
...
open class MenuBar: MenuShell, MenuBarProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuBar` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuBar>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuBarProtocol`
    /// Will retain `GtkMenuBar`.
    public convenience init<T: MenuBarProtocol>(_ other: T) {
        self.init(cast(other.menu_bar_ptr))
        g_object_ref(cast(menu_bar_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuBarProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuBar.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuBarProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuBar.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuBarProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuBar.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuBarProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuBar>(opaquePointer))
    }
    ...
    /// by means of being contained within the `GtkApplicationWindows`
    /// widget hierarchy.
    public static func newFrom(model: MenuModelProtocol) -> MenuBar! {
        let rv = gtk_menu_bar_new_from_model(cast(model.ptr))
        return rv.map { MenuBar(cast($0)) }
    }
...
public extension MenuBarProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuBarPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_bar_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuBarSignalName: String, SignalNameProtocol {
    ...
    /// The child pack direction of the menubar. It determines how
    /// the widgets contained in child menuitems are arranged.
    case notifyChildPackDirection = "notify::child-pack-direction"
    ...
    /// The pack direction of the menubar. It determines how
    /// menuitems are arranged in the menubar.
    case notifyPackDirection = "notify::pack-direction"
...
public extension MenuBarProtocol {
    /// Connect a `MenuBarSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuBarSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_bar_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuBarProtocol {
    ...
    var menu_bar_ptr: UnsafeMutablePointer<GtkMenuBar> { return ptr.assumingMemoryBound(to: GtkMenuBar.self) }

    /// Retrieves the current child pack direction of the menubar.
    /// See `gtk_menu_bar_set_child_pack_direction()`.
    func getChildPackDirection() -> GtkPackDirection {
        let rv = gtk_menu_bar_get_child_pack_direction(cast(menu_bar_ptr))
        return rv
    }

    /// Retrieves the current pack direction of the menubar.
    /// See `gtk_menu_bar_set_pack_direction()`.
    func getPackDirection() -> GtkPackDirection {
        let rv = gtk_menu_bar_get_pack_direction(cast(menu_bar_ptr))
        return rv
    }

    /// Sets how widgets should be packed inside the children of a menubar.
    func setChildPackDirection(childPackDir child_pack_dir: PackDirection) {
        gtk_menu_bar_set_child_pack_direction(cast(menu_bar_ptr), child_pack_dir)
    
    }

    /// Sets how items should be packed inside a menubar.
    func setPackDirection(packDir pack_dir: PackDirection) {
        gtk_menu_bar_set_pack_direction(cast(menu_bar_ptr), pack_dir)
    ...
    var childPackDirection: GtkPackDirection {
        ...
        /// Sets how widgets should be packed inside the children of a menubar.
        nonmutating set {
            gtk_menu_bar_set_child_pack_direction(cast(menu_bar_ptr), newValue)
        }
    }
    ...
    var packDirection: GtkPackDirection {
        ...
        /// Sets how items should be packed inside a menubar.
        nonmutating set {
            gtk_menu_bar_set_pack_direction(cast(menu_bar_ptr), newValue)
        }
    }
}
...
public extension MenuButtonRef {
    ...
    init<T: MenuButtonProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuButton: ToggleButton, MenuButtonProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuButton` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuButton>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuButtonProtocol`
    /// Will retain `GtkMenuButton`.
    public convenience init<T: MenuButtonProtocol>(_ other: T) {
        self.init(cast(other.menu_button_ptr))
        g_object_ref(cast(menu_button_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuButton.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuButton>(opaquePointer))
    }
...
public extension MenuButtonProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuButtonPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_button_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuButtonSignalName: String, SignalNameProtocol {
    ...
    /// The `GtkWidget` to use to align the menu with.
    case notifyAlignWidget = "notify::align-widget"
    /// If `true`, the button will ignore the `GtkSettings:gtk`-button-images
    /// setting and always show the image, if available.
    /// 
    /// Use this property if the button would be useless or hard to use
    ...
    /// Whether to construct a `GtkPopover` from the menu model,
    /// or a `GtkMenu`.
    case notifyUsePopover = "notify::use-popover"
...
public extension MenuButtonProtocol {
    ...
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuButtonSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_button_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuButtonProtocol {
    ...
    var menu_button_ptr: UnsafeMutablePointer<GtkMenuButton> { return ptr.assumingMemoryBound(to: GtkMenuButton.self) }

    /// Returns the parent `GtkWidget` to use to line up with menu.
    func getAlignWidget() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_menu_button_get_align_widget(cast(menu_button_ptr))
        return cast(rv)
    }

    /// Returns the direction the popup will be pointing at when popped up.
    func getDirection() -> GtkArrowType {
        let rv = gtk_menu_button_get_direction(cast(menu_button_ptr))
        return rv
    }

    /// Returns the `GMenuModel` used to generate the popup.
    func getMenuModel() -> UnsafeMutablePointer<GMenuModel>! {
        let rv = gtk_menu_button_get_menu_model(cast(menu_button_ptr))
        return cast(rv)
    }
    ...
    /// returns `nil`.
    func getPopover() -> UnsafeMutablePointer<GtkPopover>! {
        let rv = gtk_menu_button_get_popover(cast(menu_button_ptr))
        return cast(rv)
    }
    ...
    /// returns `nil`.
    func getPopup() -> UnsafeMutablePointer<GtkMenu>! {
        let rv = gtk_menu_button_get_popup(cast(menu_button_ptr))
        return cast(rv)
    }

    /// Returns whether a `GtkPopover` or a `GtkMenu` will be constructed
    /// from the menu model.
    func getUsePopover() -> Bool {
        let rv = gtk_menu_button_get_use_popover(cast(menu_button_ptr))
        return Bool(rv != 0)
    }
    ...
    func set(alignWidget align_widget: WidgetProtocol) {
        gtk_menu_button_set_align_widget(cast(menu_button_ptr), cast(align_widget.ptr))
    ...
    func set(direction: ArrowType) {
        gtk_menu_button_set_direction(cast(menu_button_ptr), direction)
    ...
    /// to `nil`.
    func set(menuModel menu_model: MenuModelProtocol) {
        gtk_menu_button_set_menu_model(cast(menu_button_ptr), cast(menu_model.ptr))
    ...
    func set(popover: WidgetProtocol) {
        gtk_menu_button_set_popover(cast(menu_button_ptr), cast(popover.ptr))
    ...
    /// are dissociated from the `menu_button`, and those properties are set to `nil`.
    func setPopup(menu: WidgetProtocol) {
        gtk_menu_button_set_popup(cast(menu_button_ptr), cast(menu.ptr))
    ...
    func set(usePopover use_popover: Bool) {
        gtk_menu_button_set_use_popover(cast(menu_button_ptr), gboolean(use_popover ? 1 : 0))
    
    }
    /// Returns the parent `GtkWidget` to use to line up with menu.
    var alignWidget: UnsafeMutablePointer<GtkWidget>! {
        /// Returns the parent `GtkWidget` to use to line up with menu.
        get {
            let rv = gtk_menu_button_get_align_widget(cast(menu_button_ptr))
            return cast(rv)
        ...
        /// and not for popovers.
        nonmutating set {
            gtk_menu_button_set_align_widget(cast(menu_button_ptr), cast(newValue))
        }
    }
    ...
    var direction: GtkArrowType {
        ...
        /// as if you passed `GTK_ARROW_DOWN` (although you won’t see any arrows).
        nonmutating set {
            gtk_menu_button_set_direction(cast(menu_button_ptr), newValue)
        }
    }

    /// Returns the `GMenuModel` used to generate the popup.
    var menuModel: UnsafeMutablePointer<GMenuModel>! {
        /// Returns the `GMenuModel` used to generate the popup.
        get {
            let rv = gtk_menu_button_get_menu_model(cast(menu_button_ptr))
            return cast(rv)
        ...
        /// to `nil`.
        nonmutating set {
            gtk_menu_button_set_menu_model(cast(menu_button_ptr), cast(newValue))
        }
    }
    ...
    var popover: UnsafeMutablePointer<GtkPopover>! {
        ...
        /// are dissociated from the `menu_button`, and those properties are set to `nil`.
        nonmutating set {
            gtk_menu_button_set_popover(cast(menu_button_ptr), cast(newValue))
        }
    }

    /// The `GtkMenu` that will be popped up when the button is clicked.
    var popup: UnsafeMutablePointer<GtkMenu>! {
        /// Returns the `GtkMenu` that pops out of the button.
        /// If the button does not use a `GtkMenu`, this function
        /// returns `nil`.
        get {
        ...
        /// are dissociated from the `menu_button`, and those properties are set to `nil`.
        nonmutating set {
            gtk_menu_button_set_popup(cast(menu_button_ptr), cast(newValue))
        }
    }
    ...
    var usePopover: Bool {
        ...
        /// this property is only consulted when a new menu model is set.
        nonmutating set {
            gtk_menu_button_set_use_popover(cast(menu_button_ptr), gboolean(newValue ? 1 : 0))
        }
    }
}
...
public struct MenuButtonAccessibleRef: MenuButtonAccessibleProtocol {
    /// Untyped pointer to the underlying `GtkMenuButtonAccessible` instance.
...
public extension MenuButtonAccessibleRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuButtonAccessible>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuButtonAccessibleProtocol`
    init<T: MenuButtonAccessibleProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuButtonAccessible: ToggleButtonAccessible, MenuButtonAccessibleProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuButtonAccessible` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuButtonAccessible>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuButtonAccessibleProtocol`
    /// Will retain `GtkMenuButtonAccessible`.
    public convenience init<T: MenuButtonAccessibleProtocol>(_ other: T) {
        self.init(cast(other.menu_button_accessible_ptr))
        g_object_ref(cast(menu_button_accessible_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonAccessibleProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuButtonAccessible.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonAccessibleProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuButtonAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonAccessibleProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuButtonAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuButtonAccessibleProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuButtonAccessible>(opaquePointer))
    }
...
public extension MenuButtonAccessibleProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuButtonAccessiblePropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_button_accessible_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuButtonAccessibleSignalName: String, SignalNameProtocol {
    /// The "active-descendant-changed" signal is emitted by an object
    /// which has the state ATK_STATE_MANAGES_DESCENDANTS when the focus
    /// object in the object changes. For instance, a table will emit the
    /// signal when the cell in the table which has focus changes.
...
public extension MenuButtonAccessibleProtocol {
    /// Connect a `MenuButtonAccessibleSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuButtonAccessibleSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_button_accessible_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuButtonAccessibleProtocol {
    ...
    var menu_button_accessible_ptr: UnsafeMutablePointer<GtkMenuButtonAccessible> { return ptr.assumingMemoryBound(to: GtkMenuButtonAccessible.self) }
...
public extension MenuItemRef {
    ...
    /// Creates a new `GtkMenuItem` whose child is a `GtkLabel`.
    static func newWith(label: UnsafePointer<gchar>) -> MenuItemRef! {
        let rv = gtk_menu_item_new_with_label(label)
    ...
    /// The label will be created using `gtk_label_new_with_mnemonic()`,
    /// so underscores in `label` indicate the mnemonic for the menu item.
    static func newWith(mnemonic label: UnsafePointer<gchar>) -> MenuItemRef! {
        let rv = gtk_menu_item_new_with_mnemonic(label)
        return rv.map { MenuItemRef(cast($0)) }
    }
}
...
open class MenuItem: Bin, MenuItemProtocol {
    ...
    public init(_ op: UnsafeMutablePointer<GtkMenuItem>) {
        super.init(cast(op))
    }
    ...
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuItem.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuItem.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuItem.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuItem>(opaquePointer))
    }
    ...
    /// Creates a new `GtkMenuItem` whose child is a `GtkLabel`.
    public static func newWith(label: UnsafePointer<gchar>) -> MenuItem! {
        let rv = gtk_menu_item_new_with_label(label)
    ...
    /// The label will be created using `gtk_label_new_with_mnemonic()`,
    /// so underscores in `label` indicate the mnemonic for the menu item.
    public static func newWith(mnemonic label: UnsafePointer<gchar>) -> MenuItem! {
        let rv = gtk_menu_item_new_with_mnemonic(label)
        return rv.map { MenuItem(cast($0)) }
    }
...
public extension MenuItemProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuItemPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_item_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuItemProtocol {
    ...
    var menu_item_ptr: UnsafeMutablePointer<GtkMenuItem> { return ptr.assumingMemoryBound(to: GtkMenuItem.self) }

    /// Emits the `GtkMenuItem::activate` signal on the given item
    func activate() {
        gtk_menu_item_activate(cast(menu_item_ptr))
    
    }

    /// Emits the `GtkMenuItem::deselect` signal on the given item.
    func deselect() {
        gtk_menu_item_deselect(cast(menu_item_ptr))
    ...
    func getAccelPath() -> String! {
        let rv = gtk_menu_item_get_accel_path(cast(menu_item_ptr))
        return rv.map { String(cString: UnsafePointer<CChar>($0)) }
    }

    /// Sets `text` on the `menu_item` label
    func getLabel() -> String! {
        let rv = gtk_menu_item_get_label(cast(menu_item_ptr))
        return rv.map { String(cString: UnsafePointer<CChar>($0)) }
    }
    ...
    func getReserveIndicator() -> Bool {
        let rv = gtk_menu_item_get_reserve_indicator(cast(menu_item_ptr))
        return Bool(rv != 0)
    }
    ...
    @available(*, deprecated) func getRightJustified() -> Bool {
        let rv = gtk_menu_item_get_right_justified(cast(menu_item_ptr))
        return Bool(rv != 0)
    }

    /// Gets the submenu underneath this menu item, if any.
    /// See `gtk_menu_item_set_submenu()`.
    func getSubmenu() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_menu_item_get_submenu(cast(menu_item_ptr))
        return cast(rv)
    }
    ...
    func getUseUnderline() -> Bool {
        let rv = gtk_menu_item_get_use_underline(cast(menu_item_ptr))
        return Bool(rv != 0)
    }

    /// Emits the `GtkMenuItem::select` signal on the given item.
    func select() {
        gtk_menu_item_select(cast(menu_item_ptr))
    ...
    func set(accelPath accel_path: UnsafePointer<gchar>) {
        gtk_menu_item_set_accel_path(cast(menu_item_ptr), accel_path)
    
    }

    /// Sets `text` on the `menu_item` label
    func set(label: UnsafePointer<gchar>) {
        gtk_menu_item_set_label(cast(menu_item_ptr), label)
    ...
    func setReserveIndicator(reserve: Bool) {
        gtk_menu_item_set_reserve_indicator(cast(menu_item_ptr), gboolean(reserve ? 1 : 0))
    ...
    @available(*, deprecated) func set(rightJustified right_justified: Bool) {
        gtk_menu_item_set_right_justified(cast(menu_item_ptr), gboolean(right_justified ? 1 : 0))
    
    }

    /// Sets or replaces the menu item’s submenu, or removes it when a `nil`
    /// submenu is passed.
    func set(submenu: MenuProtocol) {
        gtk_menu_item_set_submenu(cast(menu_item_ptr), cast(submenu.ptr))
    ...
    func set(useUnderline setting: Bool) {
        gtk_menu_item_set_use_underline(cast(menu_item_ptr), gboolean(setting ? 1 : 0))
    
    }

    /// Emits the `GtkMenuItem::toggle`-size-allocate signal on the given item.
    func toggleSizeAllocate(allocation: CInt) {
        gtk_menu_item_toggle_size_allocate(cast(menu_item_ptr), gint(allocation))
    
    }

    /// Emits the `GtkMenuItem::toggle`-size-request signal on the given item.
    func toggleSizeRequest(requisition: UnsafeMutablePointer<CInt>) {
        gtk_menu_item_toggle_size_request(cast(menu_item_ptr), cast(requisition))
    ...
    var accelPath: String! {
        ...
        /// by interning it first with `g_intern_static_string()`.
        nonmutating set {
            gtk_menu_item_set_accel_path(cast(menu_item_ptr), newValue)
        }
    }
    ...
    var label: String! {
        ...
        /// Sets `text` on the `menu_item` label
        nonmutating set {
            gtk_menu_item_set_label(cast(menu_item_ptr), newValue)
        }
    }
    ...
    var reserveIndicator: Bool {
        ...
        /// this functions.
        nonmutating set {
            gtk_menu_item_set_reserve_indicator(cast(menu_item_ptr), gboolean(newValue ? 1 : 0))
        }
    }
    ...
    var rightJustified: Bool {
        ...
        @available(*, deprecated) nonmutating set {
            gtk_menu_item_set_right_justified(cast(menu_item_ptr), gboolean(newValue ? 1 : 0))
        }
    }

    /// The submenu attached to the menu item, or `nil` if it has none.
    var submenu: UnsafeMutablePointer<GtkWidget>! {
        /// Gets the submenu underneath this menu item, if any.
        /// See `gtk_menu_item_set_submenu()`.
        get {
            let rv = gtk_menu_item_get_submenu(cast(menu_item_ptr))
        ...
        /// submenu is passed.
        nonmutating set {
            gtk_menu_item_set_submenu(cast(menu_item_ptr), cast(newValue))
        }
    }
    ...
    var useUnderline: Bool {
        ...
        /// should be used for the mnemonic accelerator key.
        nonmutating set {
            gtk_menu_item_set_use_underline(cast(menu_item_ptr), gboolean(newValue ? 1 : 0))
        }
    }
}
...
public struct MenuItemAccessibleRef: MenuItemAccessibleProtocol {
    /// Untyped pointer to the underlying `GtkMenuItemAccessible` instance.
...
public extension MenuItemAccessibleRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuItemAccessible>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuItemAccessibleProtocol`
    init<T: MenuItemAccessibleProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuItemAccessible: ContainerAccessible, MenuItemAccessibleProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuItemAccessible` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuItemAccessible>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuItemAccessibleProtocol`
    /// Will retain `GtkMenuItemAccessible`.
    public convenience init<T: MenuItemAccessibleProtocol>(_ other: T) {
        self.init(cast(other.menu_item_accessible_ptr))
        g_object_ref(cast(menu_item_accessible_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemAccessibleProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuItemAccessible.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemAccessibleProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuItemAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemAccessibleProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuItemAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuItemAccessibleProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuItemAccessible>(opaquePointer))
    }
...
public extension MenuItemAccessibleProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuItemAccessiblePropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_item_accessible_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuItemAccessibleSignalName: String, SignalNameProtocol {
    /// The "active-descendant-changed" signal is emitted by an object
    /// which has the state ATK_STATE_MANAGES_DESCENDANTS when the focus
    /// object in the object changes. For instance, a table will emit the
    /// signal when the cell in the table which has focus changes.
...
public extension MenuItemAccessibleProtocol {
    /// Connect a `MenuItemAccessibleSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuItemAccessibleSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_item_accessible_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuItemAccessibleProtocol {
    ...
    var menu_item_accessible_ptr: UnsafeMutablePointer<GtkMenuItemAccessible> { return ptr.assumingMemoryBound(to: GtkMenuItemAccessible.self) }
...
/// contains the current menu item. It will always have a GTK
/// grab and receive all key presses.
public struct MenuShellRef: MenuShellProtocol {
    /// Untyped pointer to the underlying `GtkMenuShell` instance.
...
public extension MenuShellRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuShell>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuShellProtocol`
    init<T: MenuShellProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuShell: Container, MenuShellProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuShell` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuShell>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuShellProtocol`
    /// Will retain `GtkMenuShell`.
    public convenience init<T: MenuShellProtocol>(_ other: T) {
        self.init(cast(other.menu_shell_ptr))
        g_object_ref(cast(menu_shell_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuShell.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuShell.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuShell.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuShell>(opaquePointer))
    }
...
public extension MenuShellProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuShellPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_shell_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuShellSignalName: String, SignalNameProtocol {
    case accelClosuresChanged = "accel-closures-changed"
    /// An action signal that activates the current menu item within
    /// the menu shell.
    case activateCurrent = "activate-current"
...
public extension MenuShellProtocol {
    /// Connect a `MenuShellSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuShellSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_shell_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuShellProtocol {
    ...
    var menu_shell_ptr: UnsafeMutablePointer<GtkMenuShell> { return ptr.assumingMemoryBound(to: GtkMenuShell.self) }

    /// Activates the menu item within the menu shell.
    func activateItem(menuItem menu_item: WidgetProtocol, forceDeactivate force_deactivate: Bool) {
        gtk_menu_shell_activate_item(cast(menu_shell_ptr), cast(menu_item.ptr), gboolean(force_deactivate ? 1 : 0))
    
    }

    /// Adds a new `GtkMenuItem` to the end of the menu shell's
    /// item list.
    func append(child: MenuItemProtocol) {
        gtk_menu_shell_append(cast(menu_shell_ptr), cast(child.ptr))
    ...
    func bind(model: MenuModelProtocol, actionNamespace action_namespace: UnsafePointer<gchar>, withSeparators with_separators: Bool) {
        gtk_menu_shell_bind_model(cast(menu_shell_ptr), cast(model.ptr), action_namespace, gboolean(with_separators ? 1 : 0))
    
    }

    /// Cancels the selection within the menu shell.
    func cancel() {
        gtk_menu_shell_cancel(cast(menu_shell_ptr))
    ...
    /// from the screen.
    func deactivate() {
        gtk_menu_shell_deactivate(cast(menu_shell_ptr))
    ...
    /// if any.
    func deselect() {
        gtk_menu_shell_deselect(cast(menu_shell_ptr))
    ...
    func getParentShell() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_menu_shell_get_parent_shell(cast(menu_shell_ptr))
        return cast(rv)
    }

    /// Gets the currently selected item.
    func getSelectedItem() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_menu_shell_get_selected_item(cast(menu_shell_ptr))
        return cast(rv)
    }

    /// Returns `true` if the menu shell will take the keyboard focus on popup.
    func getTakeFocus() -> Bool {
        let rv = gtk_menu_shell_get_take_focus(cast(menu_shell_ptr))
        return Bool(rv != 0)
    }
    ...
    func insert(child: WidgetProtocol, position: CInt) {
        gtk_menu_shell_insert(cast(menu_shell_ptr), cast(child.ptr), gint(position))
    ...
    func prepend(child: WidgetProtocol) {
        gtk_menu_shell_prepend(cast(menu_shell_ptr), cast(child.ptr))
    ...
    /// item.
    func selectFirst(searchSensitive search_sensitive: Bool) {
        gtk_menu_shell_select_first(cast(menu_shell_ptr), gboolean(search_sensitive ? 1 : 0))
    
    }

    /// Selects the menu item from the menu shell.
    func selectItem(menuItem menu_item: WidgetProtocol) {
        gtk_menu_shell_select_item(cast(menu_shell_ptr), cast(menu_item.ptr))
    ...
    func set(takeFocus take_focus: Bool) {
        gtk_menu_shell_set_take_focus(cast(menu_shell_ptr), gboolean(take_focus ? 1 : 0))
    ...
    /// The parent menu shell of a submenu is the `GtkMenu` or `GtkMenuBar`
    /// from which it was opened up.
    var parentShell: UnsafeMutablePointer<GtkWidget>! {
        /// Gets the parent menu shell.
        /// 
        /// The parent menu shell of a submenu is the `GtkMenu` or `GtkMenuBar`
        /// from which it was opened up.
    ...
    /// Gets the currently selected item.
    var selectedItem: UnsafeMutablePointer<GtkWidget>! {
        /// Gets the currently selected item.
        get {
            let rv = gtk_menu_shell_get_selected_item(cast(menu_shell_ptr))
            return cast(rv)
    ...
    var takeFocus: Bool {
        ...
        /// See also `gdk_keyboard_grab()`
        nonmutating set {
            gtk_menu_shell_set_take_focus(cast(menu_shell_ptr), gboolean(newValue ? 1 : 0))
        }
    }
}
...
public struct MenuShellAccessibleRef: MenuShellAccessibleProtocol {
    /// Untyped pointer to the underlying `GtkMenuShellAccessible` instance.
...
public extension MenuShellAccessibleRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuShellAccessible>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuShellAccessibleProtocol`
    init<T: MenuShellAccessibleProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MenuShellAccessible: ContainerAccessible, MenuShellAccessibleProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuShellAccessible` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuShellAccessible>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuShellAccessibleProtocol`
    /// Will retain `GtkMenuShellAccessible`.
    public convenience init<T: MenuShellAccessibleProtocol>(_ other: T) {
        self.init(cast(other.menu_shell_accessible_ptr))
        g_object_ref(cast(menu_shell_accessible_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellAccessibleProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuShellAccessible.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellAccessibleProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuShellAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellAccessibleProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuShellAccessible.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuShellAccessibleProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuShellAccessible>(opaquePointer))
    }
...
public extension MenuShellAccessibleProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuShellAccessiblePropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_shell_accessible_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuShellAccessibleSignalName: String, SignalNameProtocol {
    /// The "active-descendant-changed" signal is emitted by an object
    /// which has the state ATK_STATE_MANAGES_DESCENDANTS when the focus
    /// object in the object changes. For instance, a table will emit the
    /// signal when the cell in the table which has focus changes.
...
public extension MenuShellAccessibleProtocol {
    /// Connect a `MenuShellAccessibleSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuShellAccessibleSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_shell_accessible_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuShellAccessibleProtocol {
    ...
    var menu_shell_accessible_ptr: UnsafeMutablePointer<GtkMenuShellAccessible> { return ptr.assumingMemoryBound(to: GtkMenuShellAccessible.self) }
...
/// ```
/// 
public struct MenuToolButtonRef: MenuToolButtonProtocol {
    /// Untyped pointer to the underlying `GtkMenuToolButton` instance.
...
public extension MenuToolButtonRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMenuToolButton>) {
        ptr = UnsafeMutableRawPointer(p)    }

    /// Reference intialiser for a related type that implements `MenuToolButtonProtocol`
    init<T: MenuToolButtonProtocol>(_ other: T) {
        ptr = other.ptr
    }
    ...
    init( icon_widget: WidgetProtocol, label: UnsafePointer<gchar>) {
        let rv = gtk_menu_tool_button_new(cast(icon_widget.ptr), label)
        self.init(cast(rv))
    }
    ...
    @available(*, deprecated) init(stock stock_id: UnsafePointer<gchar>) {
        let rv = gtk_menu_tool_button_new_from_stock(stock_id)
        self.init(cast(rv))
    }
    /// Creates a new `GtkMenuToolButton`.
    /// The new `GtkMenuToolButton` will contain an icon and label from
    ...
    /// **new_from_stock is deprecated:**
    /// Use gtk_menu_tool_button_new() instead.
    @available(*, deprecated) static func menuToolButtonNewFrom(stock stock_id: UnsafePointer<gchar>) -> MenuToolButtonRef! {
        let rv = gtk_menu_tool_button_new_from_stock(stock_id)
        return rv.map { MenuToolButtonRef(cast($0)) }
    }
}
...
open class MenuToolButton: ToolButton, MenuToolButtonProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MenuToolButton` instance.
    public init(_ op: UnsafeMutablePointer<GtkMenuToolButton>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MenuToolButtonProtocol`
    /// Will retain `GtkMenuToolButton`.
    public convenience init<T: MenuToolButtonProtocol>(_ other: T) {
        self.init(cast(other.menu_tool_button_ptr))
        g_object_ref(cast(menu_tool_button_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuToolButtonProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMenuToolButton.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuToolButtonProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMenuToolButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuToolButtonProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMenuToolButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MenuToolButtonProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMenuToolButton>(opaquePointer))
    }
    ...
    /// **new_from_stock is deprecated:**
    /// Use gtk_menu_tool_button_new() instead.
    @available(*, deprecated) public static func menuToolButtonNewFrom(stock stock_id: UnsafePointer<gchar>) -> MenuToolButton! {
        let rv = gtk_menu_tool_button_new_from_stock(stock_id)
        return rv.map { MenuToolButton(cast($0)) }
    }
...
public extension MenuToolButtonProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MenuToolButtonPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(menu_tool_button_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum MenuToolButtonSignalName: String, SignalNameProtocol {
    case accelClosuresChanged = "accel-closures-changed"
    /// The "active-descendant-changed" signal is emitted by an object
    /// which has the state ATK_STATE_MANAGES_DESCENDANTS when the focus
    /// object in the object changes. For instance, a table will emit the
...
public extension MenuToolButtonProtocol {
    /// Connect a `MenuToolButtonSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MenuToolButtonSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(menu_tool_button_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MenuToolButtonProtocol {
    ...
    var menu_tool_button_ptr: UnsafeMutablePointer<GtkMenuToolButton> { return ptr.assumingMemoryBound(to: GtkMenuToolButton.self) }

    /// Gets the `GtkMenu` associated with `GtkMenuToolButton`.
    func getMenu() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_menu_tool_button_get_menu(cast(menu_tool_button_ptr))
        return cast(rv)
    }
    ...
    func setArrowTooltip(markup: UnsafePointer<gchar>) {
        gtk_menu_tool_button_set_arrow_tooltip_markup(cast(menu_tool_button_ptr), markup)
    ...
    func setArrowTooltip(text: UnsafePointer<gchar>) {
        gtk_menu_tool_button_set_arrow_tooltip_text(cast(menu_tool_button_ptr), text)
    
    }

    /// Sets the `GtkMenu` that is popped up when the user clicks on the arrow.
    /// If `menu` is NULL, the arrow button becomes insensitive.
    func set(menu: WidgetProtocol) {
        gtk_menu_tool_button_set_menu(cast(menu_tool_button_ptr), cast(menu.ptr))
    
    }
    var menu: UnsafeMutablePointer<GtkWidget>! {
        /// Gets the `GtkMenu` associated with `GtkMenuToolButton`.
        get {
            let rv = gtk_menu_tool_button_get_menu(cast(menu_tool_button_ptr))
            return cast(rv)
        ...
        /// If `menu` is NULL, the arrow button becomes insensitive.
        nonmutating set {
            gtk_menu_tool_button_set_menu(cast(menu_tool_button_ptr), cast(newValue))
        }
    }
}
...
public extension MessageDialogRef {
    ...
    init<T: MessageDialogProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class MessageDialog: Dialog, MessageDialogProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `MessageDialog` instance.
    public init(_ op: UnsafeMutablePointer<GtkMessageDialog>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MessageDialogProtocol`
    /// Will retain `GtkMessageDialog`.
    public convenience init<T: MessageDialogProtocol>(_ other: T) {
        self.init(cast(other.message_dialog_ptr))
        g_object_ref(cast(message_dialog_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MessageDialogProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMessageDialog.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MessageDialogProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMessageDialog.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MessageDialogProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMessageDialog.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MessageDialogProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMessageDialog>(opaquePointer))
    }
...
public extension MessageDialogProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MessageDialogPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(message_dialog_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MessageDialogProtocol {
    ...
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: MessageDialogSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(message_dialog_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MessageDialogProtocol {
    ...
    var message_dialog_ptr: UnsafeMutablePointer<GtkMessageDialog> { return ptr.assumingMemoryBound(to: GtkMessageDialog.self) }
    ...
    @available(*, deprecated) func getImage() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_message_dialog_get_image(cast(message_dialog_ptr))
        return cast(rv)
    }
    ...
    func getMessageArea() -> UnsafeMutablePointer<GtkWidget>! {
        let rv = gtk_message_dialog_get_message_area(cast(message_dialog_ptr))
        return cast(rv)
    }
    ...
    @available(*, deprecated) func set(image: WidgetProtocol) {
        gtk_message_dialog_set_image(cast(message_dialog_ptr), cast(image.ptr))
    ...
    func set(markup str: UnsafePointer<gchar>) {
        gtk_message_dialog_set_markup(cast(message_dialog_ptr), str)
    ...
    var image: UnsafeMutablePointer<GtkWidget>! {
        ...
        /// Use #GtkDialog to create dialogs with images
        @available(*, deprecated) nonmutating set {
            gtk_message_dialog_set_image(cast(message_dialog_ptr), cast(newValue))
        }
    }
...
public extension MiscRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMisc>) {
        ptr = UnsafeMutableRawPointer(p)    }
...
open class Misc: Widget, MiscProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `Misc` instance.
    public init(_ op: UnsafeMutablePointer<GtkMisc>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `MiscProtocol`
    /// Will retain `GtkMisc`.
    public convenience init<T: MiscProtocol>(_ other: T) {
        self.init(cast(other.misc_ptr))
        g_object_ref(cast(misc_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MiscProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMisc.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MiscProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMisc.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MiscProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMisc.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MiscProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMisc>(opaquePointer))
    }
...
public extension MiscProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MiscPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(misc_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension MiscProtocol {
    ...
    var misc_ptr: UnsafeMutablePointer<GtkMisc> { return ptr.assumingMemoryBound(to: GtkMisc.self) }
    ...
    @available(*, deprecated) func getAlignment(xalign: UnsafeMutablePointer<gfloat>, yalign: UnsafeMutablePointer<gfloat>) {
        gtk_misc_get_alignment(cast(misc_ptr), cast(xalign), cast(yalign))
    ...
    /// Use #GtkWidget alignment and margin properties.
    @available(*, deprecated) func getPadding(xpad: UnsafeMutablePointer<CInt>, ypad: UnsafeMutablePointer<CInt>) {
        gtk_misc_get_padding(cast(misc_ptr), cast(xpad), cast(ypad))
    ...
    @available(*, deprecated) func setAlignment(xalign: gfloat, yalign: gfloat) {
        gtk_misc_set_alignment(cast(misc_ptr), xalign, yalign)
    ...
    /// Use #GtkWidget alignment and margin properties.
    @available(*, deprecated) func setPadding(xpad: CInt, ypad: CInt) {
        gtk_misc_set_padding(cast(misc_ptr), gint(xpad), gint(ypad))
...
/// their main node to button and add a .model style class to it. The indicator
/// subnode is invisible in this case.
public struct ModelButtonRef: ModelButtonProtocol {
    /// Untyped pointer to the underlying `GtkModelButton` instance.
...
public extension ModelButtonRef {
    ...
    init<T: ModelButtonProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class ModelButton: Button, ModelButtonProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `ModelButton` instance.
    public init(_ op: UnsafeMutablePointer<GtkModelButton>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `ModelButtonProtocol`
    /// Will retain `GtkModelButton`.
    public convenience init<T: ModelButtonProtocol>(_ other: T) {
        self.init(cast(other.model_button_ptr))
        g_object_ref(cast(model_button_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `ModelButtonProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkModelButton.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `ModelButtonProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkModelButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `ModelButtonProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkModelButton.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `ModelButtonProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkModelButton>(opaquePointer))
    }
...
public extension ModelButtonProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: ModelButtonPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(model_button_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public enum ModelButtonSignalName: String, SignalNameProtocol {
    case accelClosuresChanged = "accel-closures-changed"
    /// The `activate` signal on GtkButton is an action signal and
    /// emitting it causes the button to animate press then release.
    /// Applications should never connect to this signal, but use the
    ...
    /// Whether to render the button contents centered instead of left-aligned.
    /// This property should be set for title-like items.
    case notifyCentered = "notify::centered"
    case notifyChild = "notify::child"
    case notifyCompositeChild = "notify::composite-child"
    /// Whether the widget is double buffered.
    ///
    ...
    /// If no icon is set, the text will be used. This is typically used for
    /// horizontal sections of linked buttons.
    case notifyIconic = "notify::iconic"
    /// The child widget to appear next to the button text.
    case notifyImage = "notify::image"
    /// The position of the image relative to the text inside the button.
    case notifyImagePosition = "notify::image-position"
    ...
    /// The name of a submenu to open when the button is activated.
    /// If this is set, the button should not have an action associated with it.
    case notifyMenuName = "notify::menu-name"
    case notifyName = "notify::name"
    case notifyNoShowAll = "notify::no-show-all"
    /// The requested opacity of the widget. See `gtk_widget_set_opacity()` for
    /// more details about window opacity.
...
public extension ModelButtonProtocol {
    /// Connect a `ModelButtonSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: ModelButtonSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(model_button_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension ModelButtonProtocol {
    ...
    var model_button_ptr: UnsafeMutablePointer<GtkModelButton> { return ptr.assumingMemoryBound(to: GtkModelButton.self) }
...
public extension MountOperationRef {
    /// Designated initialiser from the underlying `C` data type
    init(_ p: UnsafeMutablePointer<GtkMountOperation>) {
        ptr = UnsafeMutableRawPointer(p)    }
    ...
    init( parent: WindowProtocol) {
        let rv = gtk_mount_operation_new(cast(parent.ptr))
        self.init(cast(rv))
    }
}
...
open class MountOperation: Gio.MountOperation, MountOperationProtocol {
    ...
    public init(_ op: UnsafeMutablePointer<GtkMountOperation>) {
        super.init(cast(op))
    }
    ...
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MountOperationProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkMountOperation.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MountOperationProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkMountOperation.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MountOperationProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkMountOperation.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `MountOperationProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkMountOperation>(opaquePointer))
    }

    /// Creates a new `GtkMountOperation`
    public convenience init( parent: WindowProtocol) {
        let rv = gtk_mount_operation_new(cast(parent.ptr))
        self.init(cast(rv))
    }
...
public extension MountOperationProtocol {
    ...
    var mount_operation_ptr: UnsafeMutablePointer<GtkMountOperation> { return ptr.assumingMemoryBound(to: GtkMountOperation.self) }

    /// Gets the transient parent used by the `GtkMountOperation`
    func getParent() -> UnsafeMutablePointer<GtkWindow>! {
        let rv = gtk_mount_operation_get_parent(cast(mount_operation_ptr))
        return cast(rv)
    }
    ...
    func getScreen() -> UnsafeMutablePointer<GdkScreen>! {
        let rv = gtk_mount_operation_get_screen(cast(mount_operation_ptr))
        return cast(rv)
    }

    /// Sets the transient parent for windows shown by the
    /// `GtkMountOperation`.
    func set(parent: WindowProtocol) {
        gtk_mount_operation_set_parent(cast(mount_operation_ptr), cast(parent.ptr))
    
    }

    /// Sets the screen to show windows of the `GtkMountOperation` on.
    func set(screen: ScreenProtocol) {
        gtk_mount_operation_set_screen(cast(mount_operation_ptr), cast(screen.ptr))
    ...
    var isShowing: Bool {
        ...
        /// a window.
        get {
            let rv = gtk_mount_operation_is_showing(cast(mount_operation_ptr))
            return Bool(rv != 0)
        }
    }

    var parent: UnsafeMutablePointer<GtkWindow>! {
        /// Gets the transient parent used by the `GtkMountOperation`
        get {
            let rv = gtk_mount_operation_get_parent(cast(mount_operation_ptr))
            return cast(rv)
        ...
        /// `GtkMountOperation`.
        nonmutating set {
            gtk_mount_operation_set_parent(cast(mount_operation_ptr), cast(newValue))
        }
    }
    ...
    var screen: UnsafeMutablePointer<GdkScreen>! {
        ...
        /// Sets the screen to show windows of the `GtkMountOperation` on.
        nonmutating set {
            gtk_mount_operation_set_screen(cast(mount_operation_ptr), cast(newValue))
        }
    }
}
...
/// to run any native dialog in a modal way with a recursive mainloop,
/// similar to `gtk_dialog_run()`.
public struct NativeDialogRef: NativeDialogProtocol {
    /// Untyped pointer to the underlying `GtkNativeDialog` instance.
...
public extension NativeDialogRef {
    ...
    init<T: NativeDialogProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class NativeDialog: GLibObject.Object, NativeDialogProtocol {
    /// Designated initialiser from the underlying `C` data type.
    /// Ownership is transferred to the `NativeDialog` instance.
    public init(_ op: UnsafeMutablePointer<GtkNativeDialog>) {
        super.init(cast(op))
    }

    /// Reference convenience intialiser for a related type that implements `NativeDialogProtocol`
    /// Will retain `GtkNativeDialog`.
    public convenience init<T: NativeDialogProtocol>(_ other: T) {
        self.init(cast(other.native_dialog_ptr))
        g_object_ref(cast(native_dialog_ptr))
    }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `NativeDialogProtocol`.**
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: GtkNativeDialog.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `NativeDialogProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: GtkNativeDialog.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `NativeDialogProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: GtkNativeDialog.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `NativeDialogProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<GtkNativeDialog>(opaquePointer))
    }
...
public extension NativeDialogProtocol {
    ...
    @discardableResult func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: NativeDialogPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default_, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default_, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            ...
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
            let rv = GLibObject.ObjectRef(cast(native_dialog_ptr)).bindPropertyFull(sourceProperty: source, target: t, targetProperty: target_property, flags: f, transformTo: to, transformFrom: from, userData: holder) {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension NativeDialogProtocol {
    /// Connect a `NativeDialogSignalName` signal to a given signal handler.
    /// - Parameter signal: the signal to connect
    /// - Parameter flags: signal connection flags
    /// - Parameter handler: signal handler to use
    /// - Returns: positive handler ID, or a value less than or equal to `0` in case of an error
    @discardableResult func connect(signal kind: NativeDialogSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> CUnsignedLong {
        func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: GLibObject.SignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer) -> Void) -> CUnsignedLong {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(data).toOpaque())
            let callback = unsafeBitCast(handler, to: GLibObject.Callback.self)
            let rv = GLibObject.ObjectRef(cast(native_dialog_ptr)).signalConnectData(detailedSignal: name, cHandler: callback, data: holder, destroyData: {
                if let swift = UnsafeRawPointer($0) {
                    let holder = Unmanaged<GLibObject.SignalHandlerClosureHolder>.fromOpaque(swift)
                    holder.release()
                }
...
public extension NativeDialogProtocol {
    ...
    var native_dialog_ptr: UnsafeMutablePointer<GtkNativeDialog> { return ptr.assumingMemoryBound(to: GtkNativeDialog.self) }
    ...
    func destroy() {
        gtk_native_dialog_destroy(cast(native_dialog_ptr))
    
    }

    /// Returns whether the dialog is modal. See `gtk_native_dialog_set_modal()`.
    func getModal() -> Bool {
        let rv = gtk_native_dialog_get_modal(cast(native_dialog_ptr))
        return Bool(rv != 0)
    }

    /// Gets the title of the `GtkNativeDialog`.
    func getTitle() -> String! {
        let rv = gtk_native_dialog_get_title(cast(native_dialog_ptr))
        return rv.map { String(cString: UnsafePointer<CChar>($0)) }
    }
    ...
    func getTransientFor() -> UnsafeMutablePointer<GtkWindow>! {
        let rv = gtk_native_dialog_get_transient_for(cast(native_dialog_ptr))
        return cast(rv)
    }

    /// Determines whether the dialog is visible.
    func getVisible() -> Bool {
        let rv = gtk_native_dialog_get_visible(cast(native_dialog_ptr))
        return Bool(rv != 0)
    }
    ...
    func hide() {
        gtk_native_dialog_hide(cast(native_dialog_ptr))
    ...
    func run() -> CInt {
        let rv = gtk_native_dialog_run(cast(native_dialog_ptr))
        return CInt(rv)
    }
    ...
    func set(modal: Bool) {
        gtk_native_dialog_set_modal(cast(native_dialog_ptr), gboolean(modal ? 1 : 0))
    
    }

    /// Sets the title of the `GtkNativeDialog`.
    func set(title: UnsafePointer<CChar>) {
        gtk_native_dialog_set_title(cast(native_dialog_ptr), title)
    ...
    func setTransientFor(parent: WindowProtocol) {
        gtk_native_dialog_set_transient_for(cast(native_dialog_ptr), cast(parent.ptr))
    ...
    func show() {
        gtk_native_dialog_show(cast(native_dialog_ptr))
    ...
    var modal: Bool {
        ...
        /// will then disallow lowering the dialog below the parent.
        nonmutating set {
            gtk_native_dialog_set_modal(cast(native_dialog_ptr), gboolean(newValue ? 1 : 0))
        }
    }
    ...
    var title: String! {
        ...
        /// Sets the title of the `GtkNativeDialog`.
        nonmutating set {
            gtk_native_dialog_set_title(cast(native_dialog_ptr), newValue)
        }
    }
    ...
    var transientFor: UnsafeMutablePointer<GtkWindow>! {
        ...
        /// Passing `nil` for `parent` unsets the current transient window.
        nonmutating set {
            gtk_native_dialog_set_transient_for(cast(native_dialog_ptr), cast(newValue))
        }
    }

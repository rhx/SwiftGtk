...
public extension CellEditableProtocol {
    ...
    @inlinable @discardableResult func connect(signal kind: CellEditableSignalName, flags f: ConnectFlags = ConnectFlags(0), to handler: @escaping GLibObject.SignalHandler) -> Int {

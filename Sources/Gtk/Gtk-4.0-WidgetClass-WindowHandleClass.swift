...
open class WidgetClass: WidgetClassProtocol {
    ...
    /// i.e., ownership is transferred to the `WidgetClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWidgetClass>) {
    ...
    /// i.e., ownership is transferred to the `WidgetClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWidgetClass>) {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWidgetClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WidgetClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWidgetClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWidgetClass, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WidgetClassProtocol`
    /// `GtkWidgetClass` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WidgetClassProtocol`
    @inlinable public init<T: WidgetClassProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWidgetClass, cannot ref(_ptr)
    }
    ...
    deinit {
        // no reference counting for GtkWidgetClass, cannot unref(_ptr)
    }
...
/// The `WidgetPaintableClass` type acts as an owner of an underlying `GtkWidgetPaintableClass` instance.
/// It provides the methods that can operate on this data type through `WidgetPaintableClassProtocol` conformance.
/// Use `WidgetPaintableClass` as a strong reference or owner of a `GtkWidgetPaintableClass` instance.
///

open class WidgetPaintableClass: WidgetPaintableClassProtocol {
        /// Untyped pointer to the underlying `GtkWidgetPaintableClass` instance.
    /// For type-safe access, use the generated, typed pointer `_ptr` property instead.
    public let ptr: UnsafeMutableRawPointer!
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WidgetPaintableClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWidgetPaintableClass>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WidgetPaintableClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWidgetPaintableClass>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWidgetPaintableClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WidgetPaintableClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWidgetPaintableClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWidgetPaintableClass, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WidgetPaintableClassProtocol`
    /// `GtkWidgetPaintableClass` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WidgetPaintableClassProtocol`
    @inlinable public init<T: WidgetPaintableClassProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWidgetPaintableClass, cannot ref(_ptr)
    }

    /// Do-nothing destructor for `GtkWidgetPaintableClass`.
    deinit {
        // no reference counting for GtkWidgetPaintableClass, cannot unref(_ptr)
    }
...
// MARK: no WidgetPaintableClass properties

// MARK: no WidgetPaintableClass signals
...
public extension WidgetPrivateRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<GtkWidgetPrivate>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<GtkWidgetPrivate>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<GtkWidgetPrivate>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<GtkWidgetPrivate>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
    ...
    @inlinable init<T: WidgetPrivateProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class WidgetPrivate: WidgetPrivateProtocol {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WidgetPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWidgetPrivate>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WidgetPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWidgetPrivate>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWidgetPrivate` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WidgetPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWidgetPrivate>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWidgetPrivate, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WidgetPrivateProtocol`
    /// `GtkWidgetPrivate` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WidgetPrivateProtocol`
    @inlinable public init<T: WidgetPrivateProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWidgetPrivate, cannot ref(_ptr)
    }
    ...
    deinit {
        // no reference counting for GtkWidgetPrivate, cannot unref(_ptr)
    }
...
// MARK: no WidgetPrivate signals


// MARK: WidgetPrivate Record: WidgetPrivateProtocol extension (methods and fields)
public extension WidgetPrivateProtocol {
    ...
    @inlinable var _ptr: UnsafeMutablePointer<GtkWidgetPrivate>! { return ptr?.assumingMemoryBound(to: GtkWidgetPrivate.self) }
...
open class WindowClass: WindowClassProtocol {
    ...
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWindowClass>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WindowClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWindowClass>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWindowClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WindowClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWindowClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWindowClass, cannot ref(_ptr)
    }
    ...
    deinit {
        // no reference counting for GtkWindowClass, cannot unref(_ptr)
    }
...
/// The `WindowControlsClass` type acts as an owner of an underlying `GtkWindowControlsClass` instance.
/// It provides the methods that can operate on this data type through `WindowControlsClassProtocol` conformance.
/// Use `WindowControlsClass` as a strong reference or owner of a `GtkWindowControlsClass` instance.
///

open class WindowControlsClass: WindowControlsClassProtocol {
        /// Untyped pointer to the underlying `GtkWindowControlsClass` instance.
    /// For type-safe access, use the generated, typed pointer `_ptr` property instead.
    public let ptr: UnsafeMutableRawPointer!
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WindowControlsClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWindowControlsClass>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WindowControlsClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWindowControlsClass>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWindowControlsClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WindowControlsClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWindowControlsClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWindowControlsClass, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WindowControlsClassProtocol`
    /// `GtkWindowControlsClass` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WindowControlsClassProtocol`
    @inlinable public init<T: WindowControlsClassProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWindowControlsClass, cannot ref(_ptr)
    }

    /// Do-nothing destructor for `GtkWindowControlsClass`.
    deinit {
        // no reference counting for GtkWindowControlsClass, cannot unref(_ptr)
    }
...
// MARK: no WindowControlsClass properties

// MARK: no WindowControlsClass signals
...
open class WindowGroupClass: WindowGroupClassProtocol {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WindowGroupClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWindowGroupClass>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WindowGroupClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWindowGroupClass>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWindowGroupClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WindowGroupClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWindowGroupClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWindowGroupClass, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WindowGroupClassProtocol`
    /// `GtkWindowGroupClass` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WindowGroupClassProtocol`
    @inlinable public init<T: WindowGroupClassProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWindowGroupClass, cannot ref(_ptr)
    }
    ...
    deinit {
        // no reference counting for GtkWindowGroupClass, cannot unref(_ptr)
    }
...
// MARK: no WindowGroupClass signals
...
public extension WindowGroupPrivateRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<GtkWindowGroupPrivate>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<GtkWindowGroupPrivate>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<GtkWindowGroupPrivate>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<GtkWindowGroupPrivate>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
    ...
    @inlinable init<T: WindowGroupPrivateProtocol>(_ other: T) {
        ptr = other.ptr
    }
...
open class WindowGroupPrivate: WindowGroupPrivateProtocol {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WindowGroupPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWindowGroupPrivate>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WindowGroupPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWindowGroupPrivate>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWindowGroupPrivate` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WindowGroupPrivate` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWindowGroupPrivate>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWindowGroupPrivate, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WindowGroupPrivateProtocol`
    /// `GtkWindowGroupPrivate` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WindowGroupPrivateProtocol`
    @inlinable public init<T: WindowGroupPrivateProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWindowGroupPrivate, cannot ref(_ptr)
    }
    ...
    deinit {
        // no reference counting for GtkWindowGroupPrivate, cannot unref(_ptr)
    }
...
// MARK: no WindowGroupPrivate signals


// MARK: WindowGroupPrivate Record: WindowGroupPrivateProtocol extension (methods and fields)
public extension WindowGroupPrivateProtocol {
    ...
    @inlinable var _ptr: UnsafeMutablePointer<GtkWindowGroupPrivate>! { return ptr?.assumingMemoryBound(to: GtkWindowGroupPrivate.self) }
...
/// The `WindowHandleClass` type acts as an owner of an underlying `GtkWindowHandleClass` instance.
/// It provides the methods that can operate on this data type through `WindowHandleClassProtocol` conformance.
/// Use `WindowHandleClass` as a strong reference or owner of a `GtkWindowHandleClass` instance.
///

open class WindowHandleClass: WindowHandleClassProtocol {
        /// Untyped pointer to the underlying `GtkWindowHandleClass` instance.
    /// For type-safe access, use the generated, typed pointer `_ptr` property instead.
    public let ptr: UnsafeMutableRawPointer!
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `WindowHandleClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<GtkWindowHandleClass>) {
        ptr = UnsafeMutableRawPointer(op)
    }
    ...
    /// i.e., ownership is transferred to the `WindowHandleClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<GtkWindowHandleClass>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// `GtkWindowHandleClass` does not allow reference counting, so despite the name no actual retaining will occur.
    /// i.e., ownership is transferred to the `WindowHandleClass` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<GtkWindowHandleClass>) {
        ptr = UnsafeMutableRawPointer(op)
        // no reference counting for GtkWindowHandleClass, cannot ref(_ptr)
    }

    /// Reference intialiser for a related type that implements `WindowHandleClassProtocol`
    /// `GtkWindowHandleClass` does not allow reference counting.
    /// - Parameter other: an instance of a related type that implements `WindowHandleClassProtocol`
    @inlinable public init<T: WindowHandleClassProtocol>(_ other: T) {
        ptr = other.ptr
        // no reference counting for GtkWindowHandleClass, cannot ref(_ptr)
    }

    /// Do-nothing destructor for `GtkWindowHandleClass`.
    deinit {
        // no reference counting for GtkWindowHandleClass, cannot unref(_ptr)
    }
...
// MARK: no WindowHandleClass properties

// MARK: no WindowHandleClass signals

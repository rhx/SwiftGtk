...
// MARK: EntryAccessible has no signals// MARK: EntryAccessible Class: EntryAccessibleProtocol extension (methods and fields)
public extension EntryAccessibleProtocol {
...
public extension EntryCompletionProtocol {
    ...
    /// - Note: Representation of signal named `action-activated`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter index: the index of the activated action
    @discardableResult
    func onActionActivated(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: EntryCompletionRef, _ index: Int) -> Void ) -> Int {
        ...
        return signalConnectData(
            detailedSignal: "action-activated", 
            cHandler: unsafeBitCast(cCallback, to: GCallback.self), 
            data: Unmanaged.passRetained(SwiftHandler(handler)).toOpaque(), 
            destroyData: { userData, _ in UnsafeRawPointer(userData).flatMap(Unmanaged<SwiftHandler>.fromOpaque(_:))?.release() },
            connectFlags: flags
...
// MARK: EntryIconAccessible has no signals// MARK: EntryIconAccessible Class: EntryIconAccessibleProtocol extension (methods and fields)
public extension EntryIconAccessibleProtocol {
...
// MARK: EventBox has no signals// MARK: EventBox Class: EventBoxProtocol extension (methods and fields)
public extension EventBoxProtocol {
...
public extension EventControllerKeyProtocol {
    /// - Note: Representation of signal named `focus-in`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    @discardableResult
    func onFocusIn(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: EventControllerKeyRef) -> Void ) -> Int {
    ...
    /// - Note: Representation of signal named `focus-out`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    @discardableResult
    func onFocusOut(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: EventControllerKeyRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<EventControllerKeyRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer) -> Void = { unownedSelf, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(EventControllerKeyRef(raw: unownedSelf))
    ...
    @discardableResult
    func onModifiers(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: EventControllerKeyRef, _ object: Gdk.ModifierType) -> Bool ) -> Int {
...
public extension EventControllerScrollProtocol {
    ...
    @discardableResult
    func onScroll(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: EventControllerScrollRef, _ dx: Double, _ dy: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<EventControllerScrollRef, Double, Double, Void>
        let cCallback: @convention(c) (gpointer, gdouble, gdouble, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(EventControllerScrollRef(raw: unownedSelf), Double(arg1), Double(arg2))
...
public extension ExpanderProtocol {
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: Representation of signal named `notify::label-fill`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    @discardableResult
    func onNotifyLabelFill(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ExpanderRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        ...
        return signalConnectData(
            detailedSignal: "notify::label-fill", 
            cHandler: unsafeBitCast(cCallback, to: GCallback.self), 
            data: Unmanaged.passRetained(SwiftHandler(handler)).toOpaque(), 
            destroyData: { userData, _ in UnsafeRawPointer(userData).flatMap(Unmanaged<SwiftHandler>.fromOpaque(_:))?.release() },
            connectFlags: flags
...
// MARK: ExpanderAccessible has no signals// MARK: ExpanderAccessible Class: ExpanderAccessibleProtocol extension (methods and fields)
public extension ExpanderAccessibleProtocol {
...
// MARK: Signals of FileChooserButton
public extension FileChooserButtonProtocol {
    /// The `file`-set signal is emitted when the user selects a file.
    /// 
    /// Note that this signal is only emitted when the user
    /// changes the file.
    /// - Note: Representation of signal named `file-set`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    @discardableResult
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: Representation of signal named `notify::dialog`
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    @discardableResult

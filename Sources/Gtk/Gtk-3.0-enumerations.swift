...
public extension ArrowType {
    ...
    static let left_ = GTK_ARROW_LEFT /* 2 */
    /// Represents a right pointing arrow.
    static let right_ = GTK_ARROW_RIGHT /* 3 */
    /// No arrow. Since 2.10.
    static let none_ = GTK_ARROW_NONE /* 4 */
}
...
public extension BorderStyle {
    /// No visible border
    static let none_ = GTK_BORDER_STYLE_NONE /* 0 */
...
public extension BuilderError {
    ...
    static let invalid_type_function = GTK_BUILDER_ERROR_INVALID_TYPE_FUNCTION /* 0 */
    /// The input contained a tag that `GtkBuilder`
    ///  can’t handle.
    static let unhandled_tag = GTK_BUILDER_ERROR_UNHANDLED_TAG /* 1 */
    /// An attribute that is required by
    ///  `GtkBuilder` was missing.
    static let missing_attribute = GTK_BUILDER_ERROR_MISSING_ATTRIBUTE /* 2 */
    /// `GtkBuilder` found an attribute that
    ///  it doesn’t understand.
    static let invalid_attribute = GTK_BUILDER_ERROR_INVALID_ATTRIBUTE /* 3 */
    /// `GtkBuilder` found a tag that
    ///  it doesn’t understand.
    static let invalid_tag = GTK_BUILDER_ERROR_INVALID_TAG /* 4 */
    /// A required property value was
    ///  missing.
    static let missing_property_value = GTK_BUILDER_ERROR_MISSING_PROPERTY_VALUE /* 5 */
    /// `GtkBuilder` couldn’t parse
    ///  some attribute value.
    static let invalid_value = GTK_BUILDER_ERROR_INVALID_VALUE /* 6 */
    /// The input file requires a newer version
    ///  of GTK+.
    static let version_mismatch = GTK_BUILDER_ERROR_VERSION_MISMATCH /* 7 */
    /// An object id occurred twice.
    static let duplicate_id = GTK_BUILDER_ERROR_DUPLICATE_ID /* 8 */
    /// A specified object type is of the same type or
    ///  derived from the type of the composite class being extended with builder XML.
    static let object_type_refused = GTK_BUILDER_ERROR_OBJECT_TYPE_REFUSED /* 9 */
    /// The wrong type was specified in a composite class’s template XML
    static let template_mismatch = GTK_BUILDER_ERROR_TEMPLATE_MISMATCH /* 10 */
    /// The specified property is unknown for the object class.
    static let invalid_property = GTK_BUILDER_ERROR_INVALID_PROPERTY /* 11 */
    /// The specified signal is unknown for the object class.
    static let invalid_signal = GTK_BUILDER_ERROR_INVALID_SIGNAL /* 12 */
    /// An object id is unknown
    static let invalid_id = GTK_BUILDER_ERROR_INVALID_ID /* 13 */
}
...
public extension ButtonsType {
    /// no buttons at all
    static let none_ = GTK_BUTTONS_NONE /* 0 */
    /// an OK button
    ...
    /// Yes and No buttons
    static let yes_no = GTK_BUTTONS_YES_NO /* 4 */
    /// OK and Cancel buttons
    static let ok_cancel = GTK_BUTTONS_OK_CANCEL /* 5 */
}
...
public extension CornerType {
    ...
    static let top_left = GTK_CORNER_TOP_LEFT /* 0 */
    /// Place the scrollbars on the top and right of the
    ///  widget.
    static let bottom_left = GTK_CORNER_BOTTOM_LEFT /* 1 */
    /// Place the scrollbars on the left and bottom of the
    ///  widget.
    static let top_right = GTK_CORNER_TOP_RIGHT /* 2 */
    /// Place the scrollbars on the top and left of the
    ///  widget.
    static let bottom_right = GTK_CORNER_BOTTOM_RIGHT /* 3 */
}
...
public extension CssProviderError {
    ...
    /// Import error.
    static let import_ = GTK_CSS_PROVIDER_ERROR_IMPORT /* 2 */
    /// Name error.
    static let name = GTK_CSS_PROVIDER_ERROR_NAME /* 3 */
    /// Deprecation error.
    static let deprecated = GTK_CSS_PROVIDER_ERROR_DEPRECATED /* 4 */
    /// Unknown value.
    static let unknown_value = GTK_CSS_PROVIDER_ERROR_UNKNOWN_VALUE /* 5 */
}
...
public extension CssSectionType {
    ...
    static let import_ = GTK_CSS_SECTION_IMPORT /* 1 */
    /// The section defines a color. This
    ///   is a GTK extension to CSS.
    static let color_definition = GTK_CSS_SECTION_COLOR_DEFINITION /* 2 */
    /// The section defines a binding set. This
    ///   is a GTK extension to CSS.
    static let binding_set = GTK_CSS_SECTION_BINDING_SET /* 3 */
...
public extension DeleteType {
    ...
    static let word_ends = GTK_DELETE_WORD_ENDS /* 1 */
    /// Delete words.
    ...
    ///   breaks in the input.
    static let display_lines = GTK_DELETE_DISPLAY_LINES /* 3 */
    /// Delete only the portion of the
    ///   display-line to the left/right of cursor.
    static let display_line_ends = GTK_DELETE_DISPLAY_LINE_ENDS /* 4 */
    /// Delete to the end of the
    ///   paragraph. Like C-k in Emacs (or its reverse).
    static let paragraph_ends = GTK_DELETE_PARAGRAPH_ENDS /* 5 */
...
public extension DirectionType {
    /// Move forward.
    static let tab_forward = GTK_DIR_TAB_FORWARD /* 0 */
    /// Move backward.
    static let tab_backward = GTK_DIR_TAB_BACKWARD /* 1 */
    /// Move up.
    static let up = GTK_DIR_UP /* 2 */
    /// Move down.
    static let down = GTK_DIR_DOWN /* 3 */
    /// Move left.
    static let left_ = GTK_DIR_LEFT /* 4 */
    /// Move right.
    static let right_ = GTK_DIR_RIGHT /* 5 */
}
...
public extension DragResult {
    ...
    static let no_target = GTK_DRAG_RESULT_NO_TARGET /* 1 */
    /// The user cancelled the drag operation.
    static let user_cancelled = GTK_DRAG_RESULT_USER_CANCELLED /* 2 */
    /// The drag operation timed out.
    static let timeout_expired = GTK_DRAG_RESULT_TIMEOUT_EXPIRED /* 3 */
    /// The pointer or keyboard grab used
    ///  for the drag operation was broken.
    static let grab_broken = GTK_DRAG_RESULT_GRAB_BROKEN /* 4 */
...
public extension EventSequenceState {
    ...
    static let none_ = GTK_EVENT_SEQUENCE_NONE /* 0 */
...
public extension ExpanderStyle {
    ...
    static let semi_collapsed = GTK_EXPANDER_SEMI_COLLAPSED /* 1 */
    /// Intermediate style used during animation.
    static let semi_expanded = GTK_EXPANDER_SEMI_EXPANDED /* 2 */
...
public extension FileChooserAction {
    ...
    ///  existing folder.
    static let select_folder = GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER /* 2 */
    /// Indicates a mode for creating a
    ///  new folder.  The file chooser will let the user name an existing or
    ///  new folder.
    static let create_folder = GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER /* 3 */
}
...
public extension FileChooserConfirmation {
    ...
    static let accept_filename = GTK_FILE_CHOOSER_CONFIRMATION_ACCEPT_FILENAME /* 1 */
    /// The file chooser will
    ///  continue running, so as to let the user select another file name.
    static let select_again = GTK_FILE_CHOOSER_CONFIRMATION_SELECT_AGAIN /* 2 */
}
...
public extension FileChooserError {
    ...
    static let bad_filename = GTK_FILE_CHOOSER_ERROR_BAD_FILENAME /* 1 */
    /// Indicates a duplicate path (e.g. when
    ///  adding a bookmark).
    static let already_exists = GTK_FILE_CHOOSER_ERROR_ALREADY_EXISTS /* 2 */
    /// Indicates an incomplete hostname (e.g. "http://foo" without a slash after that).
    static let incomplete_hostname = GTK_FILE_CHOOSER_ERROR_INCOMPLETE_HOSTNAME /* 3 */
}
...
public extension IMPreeditStyle {
    ...
    /// Deprecated
    static let none_ = GTK_IM_PREEDIT_NONE /* 2 */
}
...
public extension IMStatusStyle {
    ...
    /// Deprecated
    static let none_ = GTK_IM_STATUS_NONE /* 2 */
}
...
public extension IconSize {
    ...
    static let small_toolbar = GTK_ICON_SIZE_SMALL_TOOLBAR /* 2 */
    /// Size appropriate for large toolbars (24px)
    static let large_toolbar = GTK_ICON_SIZE_LARGE_TOOLBAR /* 3 */
...
public extension IconThemeError {
    ...
    static let not_found = GTK_ICON_THEME_NOT_FOUND /* 0 */
...
public extension IconViewDropPosition {
    /// no drop possible
    static let no_drop = GTK_ICON_VIEW_NO_DROP /* 0 */
    /// dropped item replaces the item
    static let drop_into = GTK_ICON_VIEW_DROP_INTO /* 1 */
    /// droppped item is inserted to the left
    static let drop_left = GTK_ICON_VIEW_DROP_LEFT /* 2 */
    /// dropped item is inserted to the right
    static let drop_right = GTK_ICON_VIEW_DROP_RIGHT /* 3 */
    /// dropped item is inserted above
    static let drop_above = GTK_ICON_VIEW_DROP_ABOVE /* 4 */
    /// dropped item is inserted below
    static let drop_below = GTK_ICON_VIEW_DROP_BELOW /* 5 */
}
...
public extension ImageType {
    ...
    static let icon_name = GTK_IMAGE_ICON_NAME /* 5 */
...
public extension InputPurpose {
    /// Allow any character
    static let free_form = GTK_INPUT_PURPOSE_FREE_FORM /* 0 */
...
public extension Justification {
    ...
    static let left_ = GTK_JUSTIFY_LEFT /* 0 */
    /// The text is placed at the right edge of the label.
    static let right_ = GTK_JUSTIFY_RIGHT /* 1 */
...
public extension License {
    ...
    static let gpl_2_0 = GTK_LICENSE_GPL_2_0 /* 2 */
    /// The GNU General Public License, version 3.0 or later
    static let gpl_3_0 = GTK_LICENSE_GPL_3_0 /* 3 */
    /// The GNU Lesser General Public License, version 2.1 or later
    static let lgpl_2_1 = GTK_LICENSE_LGPL_2_1 /* 4 */
    /// The GNU Lesser General Public License, version 3.0 or later
    static let lgpl_3_0 = GTK_LICENSE_LGPL_3_0 /* 5 */
    /// The BSD standard license
    static let bsd = GTK_LICENSE_BSD /* 6 */
    /// The MIT/X11 standard license
    static let mit_x11 = GTK_LICENSE_MIT_X11 /* 7 */
    /// The Artistic License, version 2.0
    static let artistic = GTK_LICENSE_ARTISTIC /* 8 */
    /// The GNU General Public License, version 2.0 only. Since 3.12.
    static let gpl_2_0_only = GTK_LICENSE_GPL_2_0_ONLY /* 9 */
    /// The GNU General Public License, version 3.0 only. Since 3.12.
    static let gpl_3_0_only = GTK_LICENSE_GPL_3_0_ONLY /* 10 */
    /// The GNU Lesser General Public License, version 2.1 only. Since 3.12.
    static let lgpl_2_1_only = GTK_LICENSE_LGPL_2_1_ONLY /* 11 */
    /// The GNU Lesser General Public License, version 3.0 only. Since 3.12.
    static let lgpl_3_0_only = GTK_LICENSE_LGPL_3_0_ONLY /* 12 */
    /// The GNU Affero General Public License, version 3.0 or later. Since: 3.22.
    static let agpl_3_0 = GTK_LICENSE_AGPL_3_0 /* 13 */
    /// The GNU Affero General Public License, version 3.0 only. Since: 3.22.27.
    static let agpl_3_0_only = GTK_LICENSE_AGPL_3_0_ONLY /* 14 */
}
...
public extension MovementStep {
    ...
    static let logical_positions = GTK_MOVEMENT_LOGICAL_POSITIONS /* 0 */
    /// Move left or right by graphemes
    static let visual_positions = GTK_MOVEMENT_VISUAL_POSITIONS /* 1 */
    /// Move forward or back by words
    static let words = GTK_MOVEMENT_WORDS /* 2 */
    /// Move up or down lines (wrapped lines)
    static let display_lines = GTK_MOVEMENT_DISPLAY_LINES /* 3 */
    /// Move to either end of a line
    static let display_line_ends = GTK_MOVEMENT_DISPLAY_LINE_ENDS /* 4 */
    /// Move up or down paragraphs (newline-ended lines)
    static let paragraphs = GTK_MOVEMENT_PARAGRAPHS /* 5 */
    /// Move to either end of a paragraph
    static let paragraph_ends = GTK_MOVEMENT_PARAGRAPH_ENDS /* 6 */
    /// Move by pages
    static let pages = GTK_MOVEMENT_PAGES /* 7 */
    /// Move to ends of the buffer
    static let buffer_ends = GTK_MOVEMENT_BUFFER_ENDS /* 8 */
    /// Move horizontally by pages
    static let horizontal_pages = GTK_MOVEMENT_HORIZONTAL_PAGES /* 9 */
}
...
public extension PageOrientation {
    ...
    static let reverse_portrait = GTK_PAGE_ORIENTATION_REVERSE_PORTRAIT /* 2 */
...
public extension PanDirection {
    ...
    static let left_ = GTK_PAN_DIRECTION_LEFT /* 0 */
    /// panned towards the right
    static let right_ = GTK_PAN_DIRECTION_RIGHT /* 1 */
    /// panned upwards
...
public extension PathType {
    ...
    /// Deprecated
    static let widget_class = GTK_PATH_WIDGET_CLASS /* 1 */
    /// Deprecated
    static let class_ = GTK_PATH_CLASS /* 2 */
}
...
public extension PopoverConstraint {
    ...
    static let none_ = GTK_POPOVER_CONSTRAINT_NONE /* 0 */
...
public extension PositionType {
    ...
    static let left_ = GTK_POS_LEFT /* 0 */
    /// The feature is at the right edge.
    static let right_ = GTK_POS_RIGHT /* 1 */
...
public extension PrintError {
    ...
    static let internal_error = GTK_PRINT_ERROR_INTERNAL_ERROR /* 1 */
...
public extension PrintOperationAction {
    ...
    static let print_dialog = GTK_PRINT_OPERATION_ACTION_PRINT_DIALOG /* 0 */
...
public extension PrintStatus {
    ...
    static let generating_data = GTK_PRINT_STATUS_GENERATING_DATA /* 2 */
    /// The print job is being sent off to the
    ///     printer.
    static let sending_data = GTK_PRINT_STATUS_SENDING_DATA /* 3 */
    /// The print job has been sent to the printer,
    ///     but is not printed for some reason, e.g. the printer may be stopped.
    static let pending = GTK_PRINT_STATUS_PENDING /* 4 */
    /// Some problem has occurred during
    ///     printing, e.g. a paper jam.
    static let pending_issue = GTK_PRINT_STATUS_PENDING_ISSUE /* 5 */
    /// The printer is processing the print job.
    static let printing = GTK_PRINT_STATUS_PRINTING /* 6 */
    /// The printing has been completed successfully.
    static let finished = GTK_PRINT_STATUS_FINISHED /* 7 */
    /// The printing has been aborted.
    static let finished_aborted = GTK_PRINT_STATUS_FINISHED_ABORTED /* 8 */
}
...
public extension RcTokenType {
    ...
    /// Deprecated
    static let font_name = GTK_RC_TOKEN_FONT_NAME /* 285 */
    /// Deprecated
    static let bg_pixmap = GTK_RC_TOKEN_BG_PIXMAP /* 286 */
    /// Deprecated
    static let pixmap_path = GTK_RC_TOKEN_PIXMAP_PATH /* 287 */
    /// Deprecated
    ...
    /// Deprecated
    static let widget_class = GTK_RC_TOKEN_WIDGET_CLASS /* 292 */
    /// Deprecated
    static let class_ = GTK_RC_TOKEN_CLASS /* 293 */
    /// Deprecated
    ...
    /// Deprecated
    static let module_path = GTK_RC_TOKEN_MODULE_PATH /* 301 */
    /// Deprecated
    static let im_module_path = GTK_RC_TOKEN_IM_MODULE_PATH /* 302 */
    /// Deprecated
    static let im_module_file = GTK_RC_TOKEN_IM_MODULE_FILE /* 303 */
    /// Deprecated
...
public extension RecentChooserError {
    /// Indicates that a file does not exist
    static let not_found = GTK_RECENT_CHOOSER_ERROR_NOT_FOUND /* 0 */
    /// Indicates a malformed URI
    static let invalid_uri = GTK_RECENT_CHOOSER_ERROR_INVALID_URI /* 1 */
}
...
public extension RecentManagerError {
    ...
    static let not_found = GTK_RECENT_MANAGER_ERROR_NOT_FOUND /* 0 */
    /// the URI specified is not valid.
    static let invalid_uri = GTK_RECENT_MANAGER_ERROR_INVALID_URI /* 1 */
    /// the supplied string is not
    ///   UTF-8 encoded.
    static let invalid_encoding = GTK_RECENT_MANAGER_ERROR_INVALID_ENCODING /* 2 */
    /// no application has registered
    ///   the specified item.
    static let not_registered = GTK_RECENT_MANAGER_ERROR_NOT_REGISTERED /* 3 */
...
public extension RecentSortType {
    ...
    ///   resources.
    static let none_ = GTK_RECENT_SORT_NONE /* 0 */
...
public extension ReliefStyle {
    ...
    /// No relief.
    static let none_ = GTK_RELIEF_NONE /* 2 */
}
...
public extension RevealerTransitionType {
    /// No transition
    static let none_ = GTK_REVEALER_TRANSITION_TYPE_NONE /* 0 */
    /// Fade in
    static let crossfade = GTK_REVEALER_TRANSITION_TYPE_CROSSFADE /* 1 */
    /// Slide in from the left
    static let slide_right = GTK_REVEALER_TRANSITION_TYPE_SLIDE_RIGHT /* 2 */
    /// Slide in from the right
    static let slide_left = GTK_REVEALER_TRANSITION_TYPE_SLIDE_LEFT /* 3 */
    /// Slide in from the bottom
    static let slide_up = GTK_REVEALER_TRANSITION_TYPE_SLIDE_UP /* 4 */
    /// Slide in from the top
    static let slide_down = GTK_REVEALER_TRANSITION_TYPE_SLIDE_DOWN /* 5 */
}
...
public extension ScrollStep {
    ...
    static let horizontal_steps = GTK_SCROLL_HORIZONTAL_STEPS /* 3 */
    /// Scroll by horizontal pages.
    static let horizontal_pages = GTK_SCROLL_HORIZONTAL_PAGES /* 4 */
    /// Scroll to the horizontal ends.
    static let horizontal_ends = GTK_SCROLL_HORIZONTAL_ENDS /* 5 */
}
...
public extension ScrollType {
    /// No scrolling.
    static let none_ = GTK_SCROLL_NONE /* 0 */
    /// Jump to new location.
    static let jump = GTK_SCROLL_JUMP /* 1 */
    /// Step backward.
    static let step_backward = GTK_SCROLL_STEP_BACKWARD /* 2 */
    /// Step forward.
    static let step_forward = GTK_SCROLL_STEP_FORWARD /* 3 */
    /// Page backward.
    static let page_backward = GTK_SCROLL_PAGE_BACKWARD /* 4 */
    /// Page forward.
    static let page_forward = GTK_SCROLL_PAGE_FORWARD /* 5 */
    /// Step up.
    static let step_up = GTK_SCROLL_STEP_UP /* 6 */
    /// Step down.
    static let step_down = GTK_SCROLL_STEP_DOWN /* 7 */
    /// Page up.
    static let page_up = GTK_SCROLL_PAGE_UP /* 8 */
    /// Page down.
    static let page_down = GTK_SCROLL_PAGE_DOWN /* 9 */
    /// Step to the left.
    static let step_left = GTK_SCROLL_STEP_LEFT /* 10 */
    /// Step to the right.
    static let step_right = GTK_SCROLL_STEP_RIGHT /* 11 */
    /// Page to the left.
    static let page_left = GTK_SCROLL_PAGE_LEFT /* 12 */
    /// Page to the right.
    static let page_right = GTK_SCROLL_PAGE_RIGHT /* 13 */
    /// Scroll to start.
...
public extension SelectionMode {
    ...
    static let none_ = GTK_SELECTION_NONE /* 0 */
...
public extension ShadowType {
    /// No outline.
    static let none_ = GTK_SHADOW_NONE /* 0 */
    /// The outline is bevelled inwards.
    static let in_ = GTK_SHADOW_IN /* 1 */
    /// The outline is bevelled outwards like a button.
    static let out = GTK_SHADOW_OUT /* 2 */
    /// The outline has a sunken 3d appearance.
    static let etched_in = GTK_SHADOW_ETCHED_IN /* 3 */
    /// The outline has a raised 3d appearance.
    static let etched_out = GTK_SHADOW_ETCHED_OUT /* 4 */
}
...
public extension ShortcutType {
    ...
    static let gesture_pinch = GTK_SHORTCUT_GESTURE_PINCH /* 1 */
    /// The shortcut is a stretch gesture. GTK+ provides an icon and subtitle.
    static let gesture_stretch = GTK_SHORTCUT_GESTURE_STRETCH /* 2 */
    /// The shortcut is a clockwise rotation gesture. GTK+ provides an icon and subtitle.
    static let gesture_rotate_clockwise = GTK_SHORTCUT_GESTURE_ROTATE_CLOCKWISE /* 3 */
    /// The shortcut is a counterclockwise rotation gesture. GTK+ provides an icon and subtitle.
    static let gesture_rotate_counterclockwise = GTK_SHORTCUT_GESTURE_ROTATE_COUNTERCLOCKWISE /* 4 */
...
public extension SizeGroupMode {
    /// group has no effect
    static let none_ = GTK_SIZE_GROUP_NONE /* 0 */
...
public extension SizeRequestMode {
    ...
    static let height_for_width = GTK_SIZE_REQUEST_HEIGHT_FOR_WIDTH /* 0 */
    /// Prefer width-for-height geometry management
    static let width_for_height = GTK_SIZE_REQUEST_WIDTH_FOR_HEIGHT /* 1 */
    /// Don’t trade height-for-width or width-for-height
    static let constant_size = GTK_SIZE_REQUEST_CONSTANT_SIZE /* 2 */
}
...
public extension SpinButtonUpdatePolicy {
    ...
    ///     adjustment
    static let if_valid = GTK_UPDATE_IF_VALID /* 1 */
}
...
public extension SpinType {
    ...
    static let step_forward = GTK_SPIN_STEP_FORWARD /* 0 */
    /// Decrement by the adjustments step increment.
    static let step_backward = GTK_SPIN_STEP_BACKWARD /* 1 */
    /// Increment by the adjustments page increment.
    static let page_forward = GTK_SPIN_PAGE_FORWARD /* 2 */
    /// Decrement by the adjustments page increment.
    static let page_backward = GTK_SPIN_PAGE_BACKWARD /* 3 */
    /// Go to the adjustments lower bound.
    static let home = GTK_SPIN_HOME /* 4 */
    /// Go to the adjustments upper bound.
    static let end = GTK_SPIN_END /* 5 */
    /// Change by a specified amount.
    static let user_defined = GTK_SPIN_USER_DEFINED /* 6 */
}
...
public extension StackTransitionType {
    /// No transition
    static let none_ = GTK_STACK_TRANSITION_TYPE_NONE /* 0 */
    /// A cross-fade
    static let crossfade = GTK_STACK_TRANSITION_TYPE_CROSSFADE /* 1 */
    /// Slide from left to right
    static let slide_right = GTK_STACK_TRANSITION_TYPE_SLIDE_RIGHT /* 2 */
    /// Slide from right to left
    static let slide_left = GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT /* 3 */
    /// Slide from bottom up
    static let slide_up = GTK_STACK_TRANSITION_TYPE_SLIDE_UP /* 4 */
    /// Slide from top down
    static let slide_down = GTK_STACK_TRANSITION_TYPE_SLIDE_DOWN /* 5 */
    /// Slide from left or right according to the children order
    static let slide_left_right = GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT_RIGHT /* 6 */
    /// Slide from top down or bottom up according to the order
    static let slide_up_down = GTK_STACK_TRANSITION_TYPE_SLIDE_UP_DOWN /* 7 */
    /// Cover the old page by sliding up. Since 3.12
    static let over_up = GTK_STACK_TRANSITION_TYPE_OVER_UP /* 8 */
    /// Cover the old page by sliding down. Since: 3.12
    static let over_down = GTK_STACK_TRANSITION_TYPE_OVER_DOWN /* 9 */
    /// Cover the old page by sliding to the left. Since: 3.12
    static let over_left = GTK_STACK_TRANSITION_TYPE_OVER_LEFT /* 10 */
    /// Cover the old page by sliding to the right. Since: 3.12
    static let over_right = GTK_STACK_TRANSITION_TYPE_OVER_RIGHT /* 11 */
    /// Uncover the new page by sliding up. Since 3.12
    static let under_up = GTK_STACK_TRANSITION_TYPE_UNDER_UP /* 12 */
    /// Uncover the new page by sliding down. Since: 3.12
    static let under_down = GTK_STACK_TRANSITION_TYPE_UNDER_DOWN /* 13 */
    /// Uncover the new page by sliding to the left. Since: 3.12
    static let under_left = GTK_STACK_TRANSITION_TYPE_UNDER_LEFT /* 14 */
    /// Uncover the new page by sliding to the right. Since: 3.12
    static let under_right = GTK_STACK_TRANSITION_TYPE_UNDER_RIGHT /* 15 */
    /// Cover the old page sliding up or uncover the new page sliding down, according to order. Since: 3.12
    static let over_up_down = GTK_STACK_TRANSITION_TYPE_OVER_UP_DOWN /* 16 */
    /// Cover the old page sliding down or uncover the new page sliding up, according to order. Since: 3.14
    static let over_down_up = GTK_STACK_TRANSITION_TYPE_OVER_DOWN_UP /* 17 */
    /// Cover the old page sliding left or uncover the new page sliding right, according to order. Since: 3.14
    static let over_left_right = GTK_STACK_TRANSITION_TYPE_OVER_LEFT_RIGHT /* 18 */
    /// Cover the old page sliding right or uncover the new page sliding left, according to order. Since: 3.14
    static let over_right_left = GTK_STACK_TRANSITION_TYPE_OVER_RIGHT_LEFT /* 19 */
}
...
public extension TextBufferTargetInfo {
    /// Buffer contents
    static let buffer_contents = GTK_TEXT_BUFFER_TARGET_INFO_BUFFER_CONTENTS /* -1 */
    /// Rich text
    static let rich_text = GTK_TEXT_BUFFER_TARGET_INFO_RICH_TEXT /* -2 */
    /// Text
...
public extension TextDirection {
    /// No direction.
    static let none_ = GTK_TEXT_DIR_NONE /* 0 */
...
public extension TextViewLayer {
    ...
    static let below_text = GTK_TEXT_VIEW_LAYER_BELOW_TEXT /* 2 */
    /// The layer rendered above the text.  Since: 3.20
    static let above_text = GTK_TEXT_VIEW_LAYER_ABOVE_TEXT /* 3 */
}
...
public extension TextWindowType {
    ...
    static let private_ = GTK_TEXT_WINDOW_PRIVATE /* 0 */
    /// Window that floats over scrolling areas.
    static let widget = GTK_TEXT_WINDOW_WIDGET /* 1 */
    /// Scrollable text window.
    static let text = GTK_TEXT_WINDOW_TEXT /* 2 */
    /// Left side border window.
    static let left_ = GTK_TEXT_WINDOW_LEFT /* 3 */
    /// Right side border window.
    static let right_ = GTK_TEXT_WINDOW_RIGHT /* 4 */
    /// Top border window.
...
public extension ToolbarStyle {
    ...
    static let both_horiz = GTK_TOOLBAR_BOTH_HORIZ /* 3 */
}
...
public extension TreeViewColumnSizing {
    ...
    static let grow_only = GTK_TREE_VIEW_COLUMN_GROW_ONLY /* 0 */
...
public extension TreeViewDropPosition {
    ...
    static let into_or_before = GTK_TREE_VIEW_DROP_INTO_OR_BEFORE /* 2 */
    /// dropped row becomes a child or is inserted after
    static let into_or_after = GTK_TREE_VIEW_DROP_INTO_OR_AFTER /* 3 */
}
...
public extension TreeViewGridLines {
    /// No grid lines.
    static let none_ = GTK_TREE_VIEW_GRID_LINES_NONE /* 0 */
...
public extension Unit {
    /// No units.
    static let none_ = GTK_UNIT_NONE /* 0 */
...
public extension WidgetHelpType {
    ...
    /// What’s this.
    static let whats_this = GTK_WIDGET_HELP_WHATS_THIS /* 1 */
}
...
public extension WindowPosition {
    ...
    static let none_ = GTK_WIN_POS_NONE /* 0 */
...
public extension WrapMode {
    ...
    static let word_char = GTK_WRAP_WORD_CHAR /* 3 */
}

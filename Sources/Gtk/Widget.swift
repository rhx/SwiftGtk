...
@usableFromInline typealias KeySignalHandlerClosureHolder = DualClosureHolder<WidgetRef, Gdk.EventKeyRef, Void>
...
@usableFromInline typealias DragSignalHandlerClosureHolder = DualClosureHolder<WidgetRef, Gdk.DragContextRef, Void>

/// Internal type for Dragging SignalHandler closure holder
@usableFromInline typealias DragDataGetSignalHandlerClosureHolder = Closure5Holder<WidgetRef, Gdk.DragContextRef, UnsafeMutablePointer<GtkSelectionData>?, guint, guint, Void>
...
public extension WidgetProtocol {
    ...
    /// Connection helper function
    @usableFromInline internal func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: ButtonSignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer, gpointer) -> Void) -> Int {
        let opaqueHolder = Unmanaged.passRetained(data).toOpaque()
        let callback = unsafeBitCast(handler, to: GCallback.self)
        let rv = signalConnectData(detailedSignal: name, cHandler: callback, data: opaqueHolder, destroyData: {
            if let swift = $0 {
    ...
    /// Connection helper function
    @usableFromInline internal func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: DragSignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer, gpointer) -> Void) -> Int {
        let opaqueHolder = Unmanaged.passRetained(data).toOpaque()
        let callback = unsafeBitCast(handler, to: GCallback.self)
        let rv = signalConnectData(detailedSignal: name, cHandler: callback, data: opaqueHolder, destroyData: {
            if let swift = $0 {
    ...
    /// Connection helper function
    @usableFromInline internal func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: DragDataGetSignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer, gpointer, guint, guint, gpointer) -> Void) -> Int {
        let opaqueHolder = Unmanaged.passRetained(data).toOpaque()
        let callback = unsafeBitCast(handler, to: GCallback.self)
        let rv = signalConnectData(detailedSignal: name, cHandler: callback, data: opaqueHolder, destroyData: {
            if let swift = $0 {
    ...
    /// Connection helper function
    @usableFromInline internal func _connect(signal name: UnsafePointer<gchar>, flags: ConnectFlags, data: DragDataReceivedSignalHandlerClosureHolder, handler: @convention(c) @escaping (gpointer, gpointer, gint, gint, gpointer, guint, guint32, gpointer) -> Void) -> Int {
        let opaqueHolder = Unmanaged.passRetained(data).toOpaque()
        let callback = unsafeBitCast(handler, to: GCallback.self)
        let rv = signalConnectData(detailedSignal: name, cHandler: callback, data: opaqueHolder, destroyData: {
            if let swift = $0 {
    ...
    /// to provide a Swift closure that can capture its surrounding context.
    @discardableResult
    @inlinable func connectDrag(signal name: UnsafePointer<gchar>, flags f: ConnectFlags = ConnectFlags(0), handler: @escaping DragSignalHandler) -> Int {
        let rv = _connect(signal: name, flags: f, data: DualClosureHolder(handler)) {
    ...
    /// to provide a Swift closure that can capture its surrounding context.
    @discardableResult
    @inlinable func connectDragDataGet(signal name: UnsafePointer<gchar>, flags f: ConnectFlags = ConnectFlags(0), handler: @escaping DragDataGetSignalHandler) -> Int {
    ...
    /// to provide a Swift closure that can capture its surrounding context.
    @discardableResult
    @inlinable func connectDragDataReceived(signal name: UnsafePointer<gchar>, flags f: ConnectFlags = ConnectFlags(0), handler: @escaping DragDataReceivedSignalHandler) -> Int {
    ...
    /// to provide a Swift closure that can capture its surrounding context.
    @discardableResult
    @inlinable func onDraw(flags f: ConnectFlags = ConnectFlags(0), handler: @escaping WidgetSignalHandler) -> Int {
    ...
    @discardableResult
    @inlinable func onKey(event: WidgetSignalName = .keyPressEvent, flags f: ConnectFlags = ConnectFlags(0), handler: @escaping KeySignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onKeyPress(flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping KeySignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onKeyRelease(flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping KeySignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onButton(event: WidgetSignalName = .buttonPressEvent, flags f: ConnectFlags = ConnectFlags(0), handler: @escaping ButtonSignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onButtonPress(flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping ButtonSignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onButtonRelease(flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping ButtonSignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onMotion(event: WidgetSignalName = .motionNotifyEvent, flags f: ConnectFlags = ConnectFlags(0), handler h: @escaping MotionSignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onDragBegin(flags f: ConnectFlags = ConnectFlags(0), handler: @escaping DragSignalHandler) -> Int {
    ...
    /// - Returns: the corresponding return value of `g_signal_connect()`
    @discardableResult
    @inlinable func onDragDataGet(flags f: ConnectFlags = ConnectFlags(0), handler: @escaping DragDataGetSignalHandler) -> Int {

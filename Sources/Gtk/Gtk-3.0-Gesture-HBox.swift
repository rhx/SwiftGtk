...
public extension GestureProtocol {
    ...
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    @discardableResult
    func onNotifyWindow(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: GestureRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<GestureRef, ParamSpecRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(GestureRef(raw: unownedSelf), ParamSpecRef(raw: arg1))
...
// MARK: Signals of GestureMultiPress
public extension GestureMultiPressProtocol {
...
public extension GestureStylusProtocol {
    ...
    /// - Parameter p0: none
    @discardableResult
    func onDown(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: GestureStylusRef, _ object: Double, _ p0: Double) -> Void ) -> Int {
    ...
    /// - Parameter p0: none
    @discardableResult
    func onMotion(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: GestureStylusRef, _ object: Double, _ p0: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<GestureStylusRef, Double, Double, Void>
        let cCallback: @convention(c) (gpointer, gdouble, gdouble, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(GestureStylusRef(raw: unownedSelf), Double(arg1), Double(arg2))
    ...
    /// - Parameter p0: none
    @discardableResult
    func onProximity(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: GestureStylusRef, _ object: Double, _ p0: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<GestureStylusRef, Double, Double, Void>
        let cCallback: @convention(c) (gpointer, gdouble, gdouble, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(GestureStylusRef(raw: unownedSelf), Double(arg1), Double(arg2))
    ...
    /// - Parameter p0: none
    @discardableResult
    func onUp(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: GestureStylusRef, _ object: Double, _ p0: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<GestureStylusRef, Double, Double, Void>
        let cCallback: @convention(c) (gpointer, gdouble, gdouble, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(GestureStylusRef(raw: unownedSelf), Double(arg1), Double(arg2))
...
// MARK: HBox has no signals// MARK: HBox Class: HBoxProtocol extension (methods and fields)
public extension HBoxProtocol {

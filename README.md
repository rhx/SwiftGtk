...
The Swift wrappers have been tested with glib-2.46, 2.48, 2.52, 2.54, 2.56, 2.58 and 2.60, and gdk/gtk 3.18, 3.20, 3.22, and 3.24.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
